...
PyTypeObject PropertyContainerPy::Type = {
    ...
    .tp_name = "App.PropertyContainer",
    .tp_basicsize = sizeof(PropertyContainerPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "App.PropertyContainer class.",
    .tp_methods = App::PropertyContainerPy::Methods,
    .tp_getset = App::PropertyContainerPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = App::PropertyContainerPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef PropertyContainerPy::Methods[] = {
    {"getPropertyByName",
        ...
        METH_VARARGS,
        "getPropertyByName($self, name, checkOwner=0, /)\n"
        "--\n"
        "\n"
        "getPropertyByName(name: str, checkOwner: int=0, /) -> Any\n"
        "\n"
    ...
    {"getPropertyTouchList",
        ...
        METH_VARARGS,
        "getPropertyTouchList($self, name, /)\n"
        "--\n"
        "\n"
        "getPropertyTouchList(name: str, /) -> tuple\n"
        "\n"
    ...
    {"getTypeOfProperty",
        ...
        METH_VARARGS,
        "getTypeOfProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getTypeOfProperty(name: str, /) -> list\n"
        "\n"
    ...
    {"getTypeIdOfProperty",
        ...
        METH_VARARGS,
        "getTypeIdOfProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getTypeIdOfProperty(name: str, /) -> str\n"
        "\n"
    ...
    {"setEditorMode",
        ...
        METH_VARARGS,
        "setEditorMode($self, name, type, /)\n"
        "--\n"
        "\n"
        "setEditorMode(name: str, type: Union[int, List[str]], /) -> None\n"
        "\n"
    ...
    {"getEditorMode",
        ...
        METH_VARARGS,
        "getEditorMode($self, name, /)\n"
        "--\n"
        "\n"
        "getEditorMode(name: str, /) -> list\n"
        "\n"
    ...
    {"getGroupOfProperty",
        ...
        METH_VARARGS,
        "getGroupOfProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getGroupOfProperty(name: str, /) -> str\n"
        "\n"
    ...
    {"setGroupOfProperty",
        ...
        METH_VARARGS,
        "setGroupOfProperty($self, name, group, /)\n"
        "--\n"
        "\n"
        "setGroupOfProperty(name: str, group: str, /) -> None\n"
        "\n"
    ...
    {"setPropertyStatus",
        ...
        METH_VARARGS,
        "setPropertyStatus($self, name, val, /)\n"
        "--\n"
        "\n"
        "setPropertyStatus(name: str, val: Union[int, str, List[Union[str, int]]], /) -> None\n"
        "\n"
        "Set property status.\n"
        "\n"
        "name : str\n"
    ...
    {"getPropertyStatus",
        ...
        METH_VARARGS,
        "getPropertyStatus($self, name='', /)\n"
        "--\n"
        "\n"
        "getPropertyStatus(name: str='', /) -> list\n"
        "\n"
        "Get property status.\n"
        "\n"
        "name : str\n"
    ...
    {"getDocumentationOfProperty",
        ...
        METH_VARARGS,
        "getDocumentationOfProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getDocumentationOfProperty(name: str, /) -> str\n"
        "\n"
    ...
    {"setDocumentationOfProperty",
        ...
        METH_VARARGS,
        "setDocumentationOfProperty($self, name, docstring, /)\n"
        "--\n"
        "\n"
        "setDocumentationOfProperty(name: str, docstring: str, /) -> None\n"
        "\n"
    ...
    {"getEnumerationsOfProperty",
        ...
        METH_VARARGS,
        "getEnumerationsOfProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getEnumerationsOfProperty(name: str, /) -> Optional[list]\n"
        "\n"
    ...
    {"dumpPropertyContent",
        ...
        "dumpPropertyContent($self, Property, *, Compression=3)\n"
        "--\n"
        "\n"
        "dumpPropertyContent(Property: str, *, Compression: int=3) -> bytearray\n"
        "\n"
    ...
    {"restorePropertyContent",
        ...
        METH_VARARGS,
        "restorePropertyContent($self, name, obj, /)\n"
        "--\n"
        "\n"
        "restorePropertyContent(name: str, obj: object, /) -> None\n"
        "\n"
    ...
    {"renameProperty",
        reinterpret_cast<PyCFunction>( staticCallback_renameProperty ),
        METH_VARARGS,
        "renameProperty($self, oldName, newName, /)\n"
        "--\n"
        "\n"
        "renameProperty(oldName: str, newName: str, /) -> None\n"
        "\n"
        "Rename a property.\n"
        "\n"
        "oldName : str\n"
...
// renameProperty() callback and implementer
// PyObject*  PropertyContainerPy::renameProperty(PyObject *args){};
// has to be implemented in PropertyContainerPyImp.cpp
PyObject * PropertyContainerPy::staticCallback_renameProperty (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'renameProperty' of 'App.PropertyContainer' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<PropertyContainerPy*>(self)->renameProperty(args);
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
    catch(const Base::Exception& e)
    {
...
PropertyContainer *PropertyContainerPy::getTwinPtr() const
{
    return getPropertyContainerPtr();
}
