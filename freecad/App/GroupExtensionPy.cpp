...
PyMethodDef GroupExtensionPy::Methods[] = {
    {"newObject",
        ...
        METH_VARARGS,
        "newObject($self, type, name, /)\n"
        "--\n"
        "\n"
        "newObject(type: str, name: str, /) -> Any\n"
        "\n"
    ...
    {"addObjects",
        ...
        "--\n"
        "\n"
        "addObjects(objects: List[Any], /) -> List[Any]\n"
        "\n"
    ...
    {"setObjects",
        ...
        METH_VARARGS,
        "setObjects($self, objects, /)\n"
        "--\n"
        "\n"
        "setObjects(objects: List[Any], /) -> List[Any]\n"
        "\n"
    ...
    {"removeObjects",
        ...
        "--\n"
        "\n"
        "removeObjects(objects: List[Any], /) -> List[Any]\n"
        "\n"
    ...
    {"removeObjectsFromDocument",
        ...
        METH_VARARGS,
        "removeObjectsFromDocument($self)\n"
        "--\n"
        "\n"
        "removeObjectsFromDocument() -> None\n"
        "\n"
    ...
    {"getObjectsOfType",
        ...
        METH_VARARGS,
        "getObjectsOfType($self, typename, /)\n"
        "--\n"
        "\n"
        "getObjectsOfType(typename: str, /) -> List[Any]\n"
        "\n"
    ...
    {"hasObject",
        ...
        METH_VARARGS,
        "hasObject($self, obj, recursive=False, /)\n"
        "--\n"
        "\n"
        "hasObject(obj: Any, recursive: bool=False, /) -> bool\n"
        "\n"
    ...
    {"allowObject",
        ...
        METH_VARARGS,
        "allowObject($self, obj, /)\n"
        "--\n"
        "\n"
        "allowObject(obj: Any, /) -> bool\n"
        "\n"
...
GroupExtension *GroupExtensionPy::getTwinPtr() const
{
    return getGroupExtensionPtr();
}
