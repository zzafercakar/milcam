...
PyTypeObject ApplicationDirectoriesPy::Type = {
    ...
    .tp_doc = "Provides access to the directory versioning methods of its C++ counterpart.\n"
    "\n"
...
PyMethodDef ApplicationDirectoriesPy::Methods[] = {
    {"usingCurrentVersionConfig",
        ...
        "--\n"
        "\n"
        "usingCurrentVersionConfig(path: str, /) -> bool\n"
        "\n"
    ...
    {"migrateAllPaths",
        ...
        "--\n"
        "\n"
        "migrateAllPaths(paths: list[str], /) -> list[str]\n"
        "\n"
    ...
    {"versionStringForPath",
        ...
        METH_VARARGS|METH_STATIC,
        "versionStringForPath(major, minor, /)\n"
        "--\n"
        "\n"
        "versionStringForPath(major: int, minor: int, /) -> str\n"
        "\n"
    ...
    {"isVersionedPath",
        ...
        METH_VARARGS|METH_STATIC,
        "isVersionedPath(startingPath, /)\n"
        "--\n"
        "\n"
        "isVersionedPath(startingPath: str, /) -> bool\n"
        "\n"
    ...
    {"mostRecentAvailableConfigVersion",
        ...
        METH_VARARGS|METH_STATIC,
        "mostRecentAvailableConfigVersion(startingPath, /)\n"
        "--\n"
        "\n"
        "mostRecentAvailableConfigVersion(startingPath: str, /) -> str\n"
        "\n"
        "any *later* version whose directories exist\n"
    ...
    {"mostRecentConfigFromBase",
        ...
        METH_VARARGS|METH_STATIC,
        "mostRecentConfigFromBase(startingPath, /)\n"
        "--\n"
        "\n"
        "mostRecentConfigFromBase(startingPath: str, /) -> str\n"
        "\n"
    ...
    {"migrateConfig",
        ...
        "--\n"
        "\n"
        "migrateConfig(oldPath: str, newPath: str, /) -> list[str]\n"
        "\n"
...
ApplicationDirectories *ApplicationDirectoriesPy::getTwinPtr() const
{
    return getApplicationDirectoriesPtr();
}
