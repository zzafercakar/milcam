...
PyMethodDef GeoFeaturePy::Methods[] = {
    ...
    {"getGlobalPlacementOf",
        ...
        "getGlobalPlacementOf(targetObj, rootObj, subname, /)\n"
        "--\n"
        "\n"
        "getGlobalPlacementOf(targetObj: Any, rootObj: Any, subname: str, /) -> Placement\n"
        "\n"
        "Examples:\n"
        "    obj = \"part1\"\n"
    ...
    {"getPropertyNameOfGeometry",
        ...
        METH_VARARGS,
        "getPropertyNameOfGeometry($self)\n"
        "--\n"
        "\n"
        "getPropertyNameOfGeometry() -> Optional[str]\n"
        "\n"
    ...
    {"getPropertyOfGeometry",
        ...
        METH_VARARGS,
        "getPropertyOfGeometry($self)\n"
        "--\n"
        "\n"
        "getPropertyOfGeometry() -> Optional[Any]\n"
        "\n"
...
GeoFeature *GeoFeaturePy::getTwinPtr() const
{
    return getGeoFeaturePtr();
}
