...
PyMethodDef StringHasherPy::Methods[] = {
    {"getID",
        ...
        METH_VARARGS,
        "getID($self, arg, base64=False, /)\n"
        "--\n"
        "\n"
        "getID(txt: str, base64: bool=False, /) -> Any\n"
        "getID(id: int, base64: bool=False, /) -> Any\n"
        "\n"
    ...
    {"isSame",
        ...
        "--\n"
        "\n"
        "isSame(other: 'StringHasher', /) -> bool\n"
        "\n"
...
StringHasher *StringHasherPy::getTwinPtr() const
{
    return getStringHasherPtr();
}
