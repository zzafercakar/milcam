...
PyMethodDef LinkBaseExtensionPy::Methods[] = {
    {"configLinkProperty",
        ...
        "configLinkProperty($self, *args, **kwargs)\n"
        "--\n"
        "\n"
        "configLinkProperty(*args, **kwargs) -> Any\n"
        "\n"
        "Examples:\n"
    ...
    {"getLinkExtProperty",
        ...
        METH_VARARGS,
        "getLinkExtProperty($self, name, /)\n"
        "--\n"
        "\n"
        "getLinkExtProperty(name: str, /) -> Any\n"
        "\n"
    ...
    {"getLinkExtPropertyName",
        ...
        METH_VARARGS,
        "getLinkExtPropertyName($self, name, /)\n"
        "--\n"
        "\n"
        "getLinkExtPropertyName(name: str, /) -> str\n"
        "\n"
    ...
    {"getLinkPropertyInfo",
        ...
        METH_VARARGS,
        "getLinkPropertyInfo($self, arg=None, /)\n"
        "--\n"
        "\n"
        "getLinkPropertyInfo(/) -> tuple[tuple[str, str, str]]\n"
        "getLinkPropertyInfo(index: int, /) -> tuple[str, str, str]\n"
        "getLinkPropertyInfo(name: str, /) -> tuple[str, str]\n"
        "\n"
        "Overloads:\n"
    ...
    {"setLink",
        ...
        METH_VARARGS,
        "setLink($self, obj, subName=None, subElements=None, /)\n"
        "--\n"
        "\n"
        "setLink(obj: Any, subName: Optional[str]=None, subElements: Optional[Union[str, Tuple[str, ...]]]=None, /) -> None\n"
        "\n"
    ...
    {"cacheChildLabel",
        ...
        METH_VARARGS,
        "cacheChildLabel($self, enable=True, /)\n"
        "--\n"
        "\n"
        "cacheChildLabel(enable: bool=True, /) -> None\n"
        "\n"
    ...
    {"flattenSubname",
        ...
        METH_VARARGS,
        "flattenSubname($self, subname, /)\n"
        "--\n"
        "\n"
        "flattenSubname(subname: str, /) -> str\n"
        "\n"
    ...
    {"expandSubname",
        ...
        METH_VARARGS,
        "expandSubname($self, subname, /)\n"
        "--\n"
        "\n"
        "expandSubname(subname: str, /) -> str\n"
        "\n"
...
LinkBaseExtension *LinkBaseExtensionPy::getTwinPtr() const
{
    return getLinkBaseExtensionPtr();
}
