...
PyTypeObject MetadataPy::Type = {
    ...
    .tp_name = "App.Metadata",
    .tp_basicsize = sizeof(MetadataPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = App::MetadataPy::Methods,
    .tp_getset = App::MetadataPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = App::MetadataPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef MetadataPy::Methods[] = {
    {"getLastSupportedFreeCADVersion",
        ...
        METH_VARARGS,
        "getLastSupportedFreeCADVersion($self)\n"
        "--\n"
        "\n"
        "getLastSupportedFreeCADVersion() -> Optional[str]\n"
        "\n"
    ...
    {"getFirstSupportedFreeCADVersion",
        ...
        METH_VARARGS,
        "getFirstSupportedFreeCADVersion($self)\n"
        "--\n"
        "\n"
        "getFirstSupportedFreeCADVersion() -> Optional[str]\n"
        "\n"
    ...
    {"getGenericMetadata",
        ...
        METH_VARARGS,
        "getGenericMetadata($self, name, /)\n"
        "--\n"
        "\n"
        "getGenericMetadata(name: str, /) -> List[Any]\n"
        "\n"
    ...
    {"addContentItem",
        ...
        METH_VARARGS,
        "addContentItem($self, content_type, metadata, /)\n"
        "--\n"
        "\n"
        "addContentItem(content_type: str, metadata: 'Metadata', /) -> None\n"
        "\n"
    ...
    {"removeContentItem",
        ...
        METH_VARARGS,
        "removeContentItem($self, content_type, name, /)\n"
        "--\n"
        "\n"
        "removeContentItem(content_type: str, name: str, /) -> None\n"
        "\n"
    ...
    {"addMaintainer",
        ...
        METH_VARARGS,
        "addMaintainer($self, name, email, /)\n"
        "--\n"
        "\n"
        "addMaintainer(name: str, email: str, /) -> None\n"
        "\n"
    ...
    {"removeMaintainer",
        ...
        METH_VARARGS,
        "removeMaintainer($self, name, email, /)\n"
        "--\n"
        "\n"
        "removeMaintainer(name: str, email: str, /) -> None\n"
        "\n"
    ...
    {"addLicense",
        ...
        METH_VARARGS,
        "addLicense($self, short_code, path, /)\n"
        "--\n"
        "\n"
        "addLicense(short_code: str, path: str, /) -> None\n"
        "\n"
        "Add a new License."
    },
    {"removeLicense",
        ...
        METH_VARARGS,
        "removeLicense($self, short_code, /)\n"
        "--\n"
        "\n"
        "removeLicense(short_code: str, /) -> None\n"
        "\n"
        "Remove the License."
    },
    {"addUrl",
        ...
        METH_VARARGS,
        "addUrl($self, url_type, url, branch, /)\n"
        "--\n"
        "\n"
        "addUrl(url_type: str, url: str, branch: str, /) -> None\n"
        "\n"
    ...
    {"removeUrl",
        ...
        METH_VARARGS,
        "removeUrl($self, url_type, url, /)\n"
        "--\n"
        "\n"
        "removeUrl(url_type: str, url: str, /) -> None\n"
        "\n"
        "Remove the Url."
    },
    {"addAuthor",
        ...
        METH_VARARGS,
        "addAuthor($self, name, email, /)\n"
        "--\n"
        "\n"
        "addAuthor(name: str, email: str, /) -> None\n"
        "\n"
    ...
    {"removeAuthor",
        ...
        METH_VARARGS,
        "removeAuthor($self, name, email, /)\n"
        "--\n"
        "\n"
        "removeAuthor(name: str, email: str, /) -> None\n"
        "\n"
        "Remove the Author."
    },
    {"addDepend",
        ...
        METH_VARARGS,
        "addDepend($self, name, kind, optional, /)\n"
        "--\n"
        "\n"
        "addDepend(name: str, kind: str, optional: bool, /) -> None\n"
        "\n"
    ...
    {"removeDepend",
        ...
        METH_VARARGS,
        "removeDepend($self, name, kind, /)\n"
        "--\n"
        "\n"
        "removeDepend(name: str, kind: str, /) -> None\n"
        "\n"
    ...
    {"addConflict",
        ...
        METH_VARARGS,
        "addConflict($self, name, kind, /)\n"
        "--\n"
        "\n"
        "addConflict(name: str, kind: str, /) -> None\n"
        "\n"
    ...
    {"removeConflict",
        ...
        METH_VARARGS,
        "removeConflict($self, name, kind, /)\n"
        "--\n"
        "\n"
        "removeConflict(name: str, kind: str, /) -> None\n"
        "\n"
    ...
    {"addReplace",
        ...
        METH_VARARGS,
        "addReplace($self, name, /)\n"
        "--\n"
        "\n"
        "addReplace(name: str, /) -> None\n"
        "\n"
        "Add a new Replace."
    },
    {"removeReplace",
        ...
        METH_VARARGS,
        "removeReplace($self, name, /)\n"
        "--\n"
        "\n"
        "removeReplace(name: str, /) -> None\n"
        "\n"
        "Remove the Replace."
    },
    {"addTag",
...
int MetadataPy::staticCallback_setName (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setName(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setVersion (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setVersion(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setDate (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setDate(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setType (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setType(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setDescription (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setDescription(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setMaintainer (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setMaintainer(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setLicense (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setLicense(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setUrls (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setUrls(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setAuthor (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setAuthor(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setDepend (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setDepend(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setConflict (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setConflict(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setReplace (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setReplace(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setTag (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setTag(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setIcon (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setIcon(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setClassname (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setClassname(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setSubdirectory (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setSubdirectory(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setFile (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setFile(Py::List(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setContent (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setContent(Py::Dict(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setFreeCADMin (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setFreeCADMin(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setFreeCADMax (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setFreeCADMax(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
int MetadataPy::staticCallback_setPythonMin (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MetadataPy*>(self)->setPythonMin(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
Metadata *MetadataPy::getTwinPtr() const
{
...
void  MetadataPy::setName(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setVersion(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setDate(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setType(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setDescription(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setMaintainer(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setLicense(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setUrls(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setAuthor(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setDepend(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setConflict(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setReplace(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setTag(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setIcon(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setClassname(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setSubdirectory(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setFile(Py::List arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setFreeCADMin(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setFreeCADMax(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
...
void  MetadataPy::setPythonMin(Py::String arg)
{
    throw Py::AttributeError("Not yet implemented");
}
