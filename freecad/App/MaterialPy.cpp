...
PyTypeObject MaterialPy::Type = {
    ...
    .tp_doc = "This is the Material class",
    .tp_methods = App::MaterialPy::Methods,
    .tp_getset = App::MaterialPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = App::MaterialPy::PyMake
};
#if defined(__GNUC__)
