...
PyMethodDef MeasureManagerPy::Methods[] = {
    {"addMeasureType",
        ...
        "addMeasureType(id, label, measureType, /)\n"
        "--\n"
        "\n"
        "addMeasureType(id: str, label: str, measureType: MeasureType, /) -> None\n"
        "\n"
    ...
    {"getMeasureTypes",
        ...
        "--\n"
        "\n"
        "getMeasureTypes() -> List[Tuple[str, str, MeasureType]]\n"
        "\n"
...
MeasureManager *MeasureManagerPy::getTwinPtr() const
{
    return getMeasureManagerPtr();
}
