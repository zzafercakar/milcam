...
public:
    ...
    /// callback for the getPlacementOf() method
    static PyObject * staticCallback_getPlacementOf (PyObject *self, PyObject *args);
    /// implementer for the getPlacementOf() method
    PyObject*  getPlacementOf(PyObject *args);
    //@}
    ...
    DocumentObject *getTwinPtr() const;
