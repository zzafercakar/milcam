...
public:
    ...
    /// callback for the getObjectsOfType() method
    static PyObject * staticCallback_getObjectsOfType (PyObject *self, PyObject *args);
    /// implementer for the getObjectsOfType() method
    PyObject*  getObjectsOfType(PyObject *args);
    ...
    /// callback for the allowObject() method
    static PyObject * staticCallback_allowObject (PyObject *self, PyObject *args);
    /// implementer for the allowObject() method
    PyObject*  allowObject(PyObject *args);
    //@}
    ...
    GroupExtension *getTwinPtr() const;
