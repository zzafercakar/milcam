...
PyTypeObject ExtensionContainerPy::Type = {
    ...
    .tp_name = "App.ExtensionContainer",
    .tp_basicsize = sizeof(ExtensionContainerPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Base class for all objects which can be extended",
    .tp_methods = App::ExtensionContainerPy::Methods,
    .tp_getset = App::ExtensionContainerPy::GetterSetter,
    .tp_base = &App::PropertyContainerPy::Type,
    .tp_init = __PyInit,
    .tp_new = App::ExtensionContainerPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef ExtensionContainerPy::Methods[] = {
    {"addExtension",
        ...
        METH_VARARGS,
        "addExtension($self, identifier, /)\n"
        "--\n"
        "\n"
        "addExtension(identifier: str, /) -> None\n"
        "\n"
    ...
    {"hasExtension",
        ...
        METH_VARARGS,
        "hasExtension($self, identifier, /)\n"
        "--\n"
        "\n"
        "hasExtension(identifier: str, /) -> bool\n"
        "\n"
...
ExtensionContainer *ExtensionContainerPy::getTwinPtr() const
{
    return getExtensionContainerPtr();
}
...
PyObject *ExtensionContainerPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
...
{
    return {"<ExtensionContainer object>"};
}
