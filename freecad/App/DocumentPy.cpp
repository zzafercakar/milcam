...
PyTypeObject DocumentPy::Type = {
    ...
    .tp_name = "App.Document",
    .tp_basicsize = sizeof(DocumentPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This is the Document class.",
    .tp_methods = App::DocumentPy::Methods,
    .tp_getset = App::DocumentPy::GetterSetter,
    .tp_base = &App::PropertyContainerPy::Type,
    .tp_init = __PyInit,
    .tp_new = App::DocumentPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef DocumentPy::Methods[] = {
    ...
    {"getUniqueObjectName",
        ...
        METH_VARARGS,
        "getUniqueObjectName($self, objName, /)\n"
        "--\n"
        "\n"
        "getUniqueObjectName(objName: str, /) -> str\n"
        "\n"
    ...
    {"mergeProject",
        ...
        METH_VARARGS,
        "mergeProject($self, path, /)\n"
        "--\n"
        "\n"
        "mergeProject(path: str, /) -> None\n"
        "\n"
    ...
    {"exportGraphviz",
        ...
        METH_VARARGS,
        "exportGraphviz($self, path=None, /)\n"
        "--\n"
        "\n"
        "exportGraphviz(path: str=None, /) -> str | None\n"
        "\n"
    ...
    {"openTransaction",
        ...
        METH_VARARGS,
        "openTransaction($self, name, /)\n"
        "--\n"
        "\n"
        "openTransaction(name: str, /) -> None\n"
        "\n"
    ...
    {"addObject",
        ...
        "addObject($self, type, name=None, objProxy=None, viewProxy=None, attach=False, viewType=None)\n"
        "--\n"
        "\n"
        "addObject(type: str, name: str=None, objProxy: object=None, viewProxy: object=None, attach: bool=False, viewType: str=None) -> DocumentObject\n"
        "\n"
    ...
    {"addProperty",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "addProperty($self, type, name, group='', doc='', attr=0, read_only=False, hidden=False, locked=False, enum_vals=None)\n"
        "--\n"
        "\n"
        "addProperty(type: str, name: str, group: str='', doc: str='', attr: int=0, read_only: bool=False, hidden: bool=False, locked: bool=False, enum_vals: list[str] | None=None) -> Document\n"
        "\n"
    ...
    {"copyObject",
        reinterpret_cast<PyCFunction>(reinterpret_cast<void (*) ()>( staticCallback_copyObject )),
        METH_VARARGS|METH_KEYWORDS,
        "copyObject($self, object, *, recursive=False, return_all=False)\n"
        "--\n"
        "\n"
        "copyObject(object: DocumentObject, *, recursive: bool=False, return_all: bool=False) -> tuple[DocumentObject, ...]\n"
        "\n"
    ...
    {"moveObject",
        ...
        METH_VARARGS,
        "moveObject($self, object, with_dependencies=False, /)\n"
        "--\n"
        "\n"
        "moveObject(object: DocumentObject, with_dependencies: bool=False, /) -> DocumentObject\n"
        "\n"
    ...
    {"importLinks",
        ...
        METH_VARARGS,
        "importLinks($self, object=None, /)\n"
        "--\n"
        "\n"
        "importLinks(object: DocumentObject=None, /) -> tuple[DocumentObject, ...]\n"
        "\n"
    ...
    {"setClosable",
        ...
        "--\n"
        "\n"
        "setClosable(closable: bool, /) -> None\n"
        "\n"
    ...
    {"setAutoCreated",
        reinterpret_cast<PyCFunction>( staticCallback_setAutoCreated ),
        METH_VARARGS,
        "setAutoCreated($self, autoCreated, /)\n"
        "--\n"
        "\n"
        "setAutoCreated(autoCreated: bool, /) -> None\n"
        "\n"
        "Set a flag that indicates if a document is autoCreated"
    },
    {"isAutoCreated",
        reinterpret_cast<PyCFunction>( staticCallback_isAutoCreated ),
        METH_VARARGS,
        "isAutoCreated($self)\n"
        "--\n"
        "\n"
    ...
    {"recompute",
        ...
        METH_VARARGS,
        "recompute($self, objs=None, force=False, check_cycle=False, /)\n"
        "--\n"
        "\n"
        "recompute(objs: Sequence[DocumentObject]=None, force: bool=False, check_cycle: bool=False, /) -> int\n"
        "\n"
    ...
    {"getObjectsByLabel",
        ...
        METH_VARARGS,
        "getObjectsByLabel($self, label, /)\n"
        "--\n"
        "\n"
        "getObjectsByLabel(label: str, /) -> list[DocumentObject]\n"
        "\n"
    ...
    {"findObjects",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "findObjects($self, Type=None, Name=None, Label=None)\n"
        "--\n"
        "\n"
        "findObjects(Type: str=None, Name: str=None, Label: str=None) -> list[DocumentObject]\n"
        "\n"
    ...
    {"getLinksTo",
        ...
        METH_VARARGS,
        "getLinksTo($self, obj, options=0, maxCount=0, /)\n"
        "--\n"
        "\n"
        "getLinksTo(obj: DocumentObject, options: int=0, maxCount: int=0, /) -> tuple[DocumentObject, ...]\n"
        "\n"
    ...
    {"getDependentDocuments",
        ...
        METH_VARARGS,
        "getDependentDocuments($self, sort=True, /)\n"
        "--\n"
        "\n"
        "getDependentDocuments(sort: bool=True, /) -> list[DocumentObject]\n"
        "\n"
    ...
    {"getBookedTransactionID",
        reinterpret_cast<PyCFunction>( staticCallback_getBookedTransactionID ),
        METH_VARARGS,
        "getBookedTransactionID($self)\n"
        "--\n"
        "\n"
...
// has to be implemented in DocumentPyImp.cpp
PyObject * DocumentPy::staticCallback_copyObject (PyObject *self, PyObject *args, PyObject * kwd)
{
    // make sure that not a null pointer is passed
    if (!self) {
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentPy*>(self)->copyObject(args, kwd);
        if (ret != nullptr)
            static_cast<DocumentPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// setAutoCreated() callback and implementer
// PyObject*  DocumentPy::setAutoCreated(PyObject *args){};
// has to be implemented in DocumentPyImp.cpp
PyObject * DocumentPy::staticCallback_setAutoCreated (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'setAutoCreated' of 'App.Document' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentPy*>(self)->setAutoCreated(args);
        if (ret != nullptr)
            static_cast<DocumentPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// isAutoCreated() callback and implementer
// PyObject*  DocumentPy::isAutoCreated(PyObject *args){};
// has to be implemented in DocumentPyImp.cpp
PyObject * DocumentPy::staticCallback_isAutoCreated (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'isAutoCreated' of 'App.Document' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentPy*>(self)->isAutoCreated(args);
        if (ret != nullptr)
            static_cast<DocumentPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// getBookedTransactionID() callback and implementer
// PyObject*  DocumentPy::getBookedTransactionID(PyObject *args){};
// has to be implemented in DocumentPyImp.cpp
PyObject * DocumentPy::staticCallback_getBookedTransactionID (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getBookedTransactionID' of 'App.Document' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentPy*>(self)->getBookedTransactionID(args);
        if (ret != nullptr)
            static_cast<DocumentPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
int DocumentPy::staticCallback_setUndoMode (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<DocumentPy*>(self)->setUndoMode(Py::Long(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
Document *DocumentPy::getTwinPtr() const
{
...
PyObject* DocumentPy::copyObject(PyObject *args, PyObject *kwds)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not yet implemented");
    return nullptr;
}
