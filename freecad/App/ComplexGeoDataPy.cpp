...
PyTypeObject ComplexGeoDataPy::Type = {
    ...
    .tp_name = "Data.ComplexGeoData",
    .tp_basicsize = sizeof(ComplexGeoDataPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Father of all complex geometric data types.",
    .tp_methods = Data::ComplexGeoDataPy::Methods,
    .tp_getset = Data::ComplexGeoDataPy::GetterSetter,
    .tp_base = &Base::PersistencePy::Type,
    .tp_init = __PyInit,
    .tp_new = Data::ComplexGeoDataPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef ComplexGeoDataPy::Methods[] = {
    ...
    {"applyTranslation",
        ...
        METH_VARARGS,
        "applyTranslation($self, translation, /)\n"
        "--\n"
        "\n"
        "applyTranslation(translation: Vector, /) -> None\n"
        "\n"
    ...
    {"applyRotation",
        ...
        METH_VARARGS,
        "applyRotation($self, rotation, /)\n"
        "--\n"
        "\n"
        "applyRotation(rotation: Rotation, /) -> None\n"
        "\n"
    ...
    {"transformGeometry",
        ...
        METH_VARARGS,
        "transformGeometry($self, transformation, /)\n"
        "--\n"
        "\n"
        "transformGeometry(transformation: Matrix, /) -> None\n"
        "\n"
    ...
    {"setElementName",
        ...
        "setElementName($self, *, element, name=None, postfix=None, overwrite=False, sid=None)\n"
        "--\n"
        "\n"
        "setElementName(*, element: str, name: str=None, postfix: str=None, overwrite: bool=False, sid: Any=None) -> None\n"
        "\n"
        "Set an element name.\n"
        "\n"
        "Args:\n"
    ...
    {"getElementName",
        ...
        METH_VARARGS,
        "getElementName($self, name, direction=0, /)\n"
        "--\n"
        "\n"
        "getElementName(name: str, direction: int=0, /) -> str\n"
        "\n"
    ...
    {"getElementIndexedName",
        ...
        METH_VARARGS,
        "getElementIndexedName($self, name, /)\n"
        "--\n"
        "\n"
        "getElementIndexedName(name: str, /) -> str | tuple[str, list[int]]\n"
        "\n"
    ...
    {"getElementMappedName",
        ...
        METH_VARARGS,
        "getElementMappedName($self, name, /)\n"
        "--\n"
        "\n"
        "getElementMappedName(name: str, /) -> str | tuple[str, list[int]]\n"
        "\n"
...
int ComplexGeoDataPy::staticCallback_setTag (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<ComplexGeoDataPy*>(self)->setTag(Py::Long(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
...
ComplexGeoData *ComplexGeoDataPy::getTwinPtr() const
{
    return getComplexGeoDataPtr();
}
...
void  ComplexGeoDataPy::setTag(Py::Long arg)
{
    throw Py::AttributeError("Not yet implemented");
}
