...
PyMethodDef DocumentObjectPy::Methods[] = {
    {"addProperty",
        ...
        "addProperty($self, type, name, group='', doc='', attr=0, read_only=False, hidden=False, locked=False, enum_vals=[])\n"
        "--\n"
        "\n"
        "addProperty(type: str, name: str, group: str='', doc: str='', attr: int=0, read_only: bool=False, hidden: bool=False, locked: bool=False, enum_vals: list=[]) -> 'DocumentObject'\n"
        "\n"
    ...
    {"removeProperty",
        ...
        METH_VARARGS,
        "removeProperty($self, string, /)\n"
        "--\n"
        "\n"
        "removeProperty(string: str, /) -> None\n"
        "\n"
    ...
    {"enforceRecompute",
        ...
        METH_VARARGS,
        "enforceRecompute($self)\n"
        "--\n"
        "\n"
        "enforceRecompute() -> None\n"
        "\n"
    ...
    {"setExpression",
        ...
        METH_VARARGS,
        "setExpression($self, name, expression, /)\n"
        "--\n"
        "\n"
        "setExpression(name: str, expression: str, /) -> None\n"
        "\n"
    ...
    {"clearExpression",
        ...
        METH_VARARGS,
        "clearExpression($self, name, /)\n"
        "--\n"
        "\n"
        "clearExpression(name: str, /) -> None\n"
        "\n"
    ...
    {"evalExpression",
        ...
        "evalExpression($cls, expression, /)\n"
        "--\n"
        "\n"
        "evalExpression(expression: str, /) -> Any\n"
        "\n"
    ...
    {"recompute",
        ...
        METH_VARARGS,
        "recompute($self, recursive=False, /)\n"
        "--\n"
        "\n"
        "recompute(recursive: bool=False, /) -> None\n"
        "\n"
    ...
    {"getSubObject",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "getSubObject($self, subname, *, retType=0, matrix=None, transform=True, depth=0)\n"
        "--\n"
        "\n"
        "getSubObject(subname: Union[str, List[str], Tuple[str, ...]], *, retType: int=0, matrix: Matrix=None, transform: bool=True, depth: int=0) -> Any\n"
        "\n"
    ...
    {"getSubObjectList",
        ...
        METH_VARARGS,
        "getSubObjectList($self, subname, /)\n"
        "--\n"
        "\n"
        "getSubObjectList(subname: str, /) -> list\n"
        "\n"
    ...
    {"getSubObjects",
        ...
        METH_VARARGS,
        "getSubObjects($self, reason=0, /)\n"
        "--\n"
        "\n"
        "getSubObjects(reason: int=0, /) -> list\n"
        "\n"
    ...
    {"getLinkedObject",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "getLinkedObject($self, *, recursive=True, matrix=None, transform=True, depth=0)\n"
        "--\n"
        "\n"
        "getLinkedObject(*, recursive: bool=True, matrix: Matrix=None, transform: bool=True, depth: int=0) -> Any\n"
        "\n"
    ...
    {"setElementVisible",
        ...
        METH_VARARGS,
        "setElementVisible($self, element, visible, /)\n"
        "--\n"
        "\n"
        "setElementVisible(element: str, visible: bool, /) -> int\n"
        "\n"
    ...
    {"isElementVisible",
        ...
        METH_VARARGS,
        "isElementVisible($self, element, /)\n"
        "--\n"
        "\n"
        "isElementVisible(element: str, /) -> int\n"
        "\n"
    ...
    {"getParentGroup",
        ...
        "--\n"
        "\n"
        "getParentGroup() -> DocumentObjectGroup\n"
        "\n"
    ...
    {"getParentGeoFeatureGroup",
        ...
        METH_VARARGS,
        "getParentGeoFeatureGroup($self)\n"
        "--\n"
        "\n"
        "getParentGeoFeatureGroup() -> Any\n"
        "\n"
    ...
    {"getPathsByOutList",
        ...
        METH_VARARGS,
        "getPathsByOutList($self)\n"
        "--\n"
        "\n"
        "getPathsByOutList() -> list\n"
        "\n"
    ...
    {"resolve",
        ...
        METH_VARARGS,
        "resolve($self, subname, /)\n"
        "--\n"
        "\n"
        "resolve(subname: str, /) -> tuple\n"
        "\n"
    ...
    {"resolveSubElement",
        ...
        METH_VARARGS,
        "resolveSubElement($self, subname, append, type, /)\n"
        "--\n"
        "\n"
        "resolveSubElement(subname: str, append: bool, type: int, /) -> tuple\n"
        "\n"
    ...
    {"adjustRelativeLinks",
        ...
        METH_VARARGS,
        "adjustRelativeLinks($self, parent, recursive=True, /)\n"
        "--\n"
        "\n"
        "adjustRelativeLinks(parent: DocumentObject, recursive: bool=True, /) -> bool\n"
        "\n"
    ...
    {"getElementMapVersion",
        ...
        METH_VARARGS,
        "getElementMapVersion($self, property_name, /)\n"
        "--\n"
        "\n"
        "getElementMapVersion(property_name: str, /) -> str\n"
        "\n"
    ...
    {"getPlacementOf",
        reinterpret_cast<PyCFunction>( staticCallback_getPlacementOf ),
        METH_VARARGS,
        "getPlacementOf($self, subname, target=None, /)\n"
        "--\n"
        "\n"
        "getPlacementOf(subname: str, target: DocumentObject=None, /) -> Any\n"
        "\n"
...
// getPlacementOf() callback and implementer
// PyObject*  DocumentObjectPy::getPlacementOf(PyObject *args){};
// has to be implemented in DocumentObjectPyImp.cpp
PyObject * DocumentObjectPy::staticCallback_getPlacementOf (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'getPlacementOf' of 'App.DocumentObject' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<DocumentObjectPy*>(self)->getPlacementOf(args);
        if (ret != nullptr)
            static_cast<DocumentObjectPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
DocumentObject *DocumentObjectPy::getTwinPtr() const
{
