...
public:
    ...
    PyObject*  dumpPropertyContent(PyObject *args, PyObject *kwd) const;
    ...
    /// callback for the renameProperty() method
    static PyObject * staticCallback_renameProperty (PyObject *self, PyObject *args);
    /// implementer for the renameProperty() method
    PyObject*  renameProperty(PyObject *args) const;
    //@}
    ...
    PropertyContainer *getTwinPtr() const;
