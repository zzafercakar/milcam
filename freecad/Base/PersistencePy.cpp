...
PyMethodDef PersistencePy::Methods[] = {
    {"dumpContent",
        ...
        "dumpContent($self, Compression=3)\n"
        "--\n"
        "\n"
        "dumpContent(Compression: int=3) -> bytearray\n"
        "\n"
    ...
    {"restoreContent",
        ...
        METH_VARARGS,
        "restoreContent($self, obj, /)\n"
        "--\n"
        "\n"
        "restoreContent(obj: object, /) -> None\n"
        "\n"
...
Persistence *PersistencePy::getTwinPtr() const
{
    return getPersistencePtr();
}
