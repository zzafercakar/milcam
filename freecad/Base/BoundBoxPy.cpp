...
PyMethodDef BoundBoxPy::Methods[] = {
    ...
    {"add",
        ...
        "--\n"
        "\n"
        "add(minMax: Vector, /) -> None\n"
        "add(minMax: Tuple[float, float, float], /) -> None\n"
        "add(x: float, y: float, z: float, /) -> None\n"
        "\n"
    ...
    {"getEdge",
        ...
        "--\n"
        "\n"
        "getEdge(index: int, /) -> Tuple[Vector, ...]\n"
        "\n"
    ...
    {"closestPoint",
        ...
        METH_VARARGS,
        "closestPoint($self, *args, **kwargs)\n"
        "--\n"
        "\n"
        "closestPoint(point: Vector, /) -> Vector\n"
        "closestPoint(x: float, y: float, z: float, /) -> Vector\n"
        "\n"
    ...
    {"intersect",
        ...
        "--\n"
        "\n"
        "intersect(boundBox2: 'BoundBox', /) -> bool\n"
        "intersect(base: Union[Vector, Tuple[float, float, float]], dir: Union[Vector, Tuple[float, float, float]], /) -> bool\n"
        "\n"
    ...
    {"intersected",
        ...
        METH_VARARGS,
        "intersected($self, boundBox2, /)\n"
        "--\n"
        "\n"
        "intersected(boundBox2: 'BoundBox', /) -> 'BoundBox'\n"
        "\n"
    ...
    {"united",
        ...
        METH_VARARGS,
        "united($self, boundBox2, /)\n"
        "--\n"
        "\n"
        "united(boundBox2: 'BoundBox', /) -> 'BoundBox'\n"
        "\n"
    ...
    {"enlarge",
        ...
        METH_VARARGS,
        "enlarge($self, variation, /)\n"
        "--\n"
        "\n"
        "enlarge(variation: float, /) -> None\n"
        "\n"
    ...
    {"getIntersectionPoint",
        ...
        METH_VARARGS,
        "getIntersectionPoint($self, base, dir, epsilon=0.0001, /)\n"
        "--\n"
        "\n"
        "getIntersectionPoint(base: Vector, dir: Vector, epsilon: float=0.0001, /) -> Vector\n"
        "\n"
    ...
    {"move",
        ...
        "--\n"
        "\n"
        "move(displacement: Vector, /) -> None\n"
        "move(displacement: Tuple[float, float, float], /) -> None\n"
        "move(x: float, y: float, z: float, /) -> None\n"
        "\n"
    ...
    {"scale",
        ...
        "--\n"
        "\n"
        "scale(factor: Vector, /) -> None\n"
        "scale(factor: Tuple[float, float, float], /) -> None\n"
    ...
    {"transformed",
        ...
        "--\n"
        "\n"
        "transformed(matrix: Matrix, /) -> 'BoundBox'\n"
        "\n"
    ...
    {"isCutPlane",
        ...
        METH_VARARGS,
        "isCutPlane($self, base, normal, /)\n"
        "--\n"
        "\n"
        "isCutPlane(base: Vector, normal: Vector, /) -> bool\n"
        "\n"
    ...
    {"isInside",
        ...
        "--\n"
        "\n"
        "isInside(object: Vector, /) -> bool\n"
        "isInside(object: 'BoundBox', /) -> bool\n"
...
BoundBox3d *BoundBoxPy::getTwinPtr() const
{
    return getBoundBoxPtr();
}
