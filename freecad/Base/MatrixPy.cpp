...
PyTypeObject MatrixPy::Type = {
    ...
    .tp_name = "Base.Matrix",
    .tp_basicsize = sizeof(MatrixPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_number = Base::MatrixPy::Number,
    .tp_getattro = __getattro,
    .tp_setattro = __setattro,
    /* --- Flags to define presence of optional/expanded features */
    .tp_flags = Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT,
    .tp_doc = "Base.Matrix class.\n"
    "\n"
    "A 4x4 Matrix.\n"
    ...
    .tp_richcompare = Base::MatrixPy::richCompare,
    .tp_methods = Base::MatrixPy::Methods,
    .tp_getset = Base::MatrixPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::MatrixPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef MatrixPy::Methods[] = {
    ...
    {"hasScale",
        ...
        "--\n"
        "\n"
        "hasScale(tol: float=0, /) -> ScaleType\n"
        "\n"
    ...
    {"decompose",
        ...
        "--\n"
        "\n"
        "decompose() -> Tuple['Matrix', 'Matrix', 'Matrix', 'Matrix']\n"
        "\n"
    ...
    {"isUnity",
        ...
        METH_VARARGS,
        "isUnity($self, tol=0.0, /)\n"
        "--\n"
        "\n"
        "isUnity(tol: float=0.0, /) -> bool\n"
        "\n"
    ...
    {"transform",
        ...
        METH_VARARGS,
        "transform($self, vector, matrix2, /)\n"
        "--\n"
        "\n"
        "transform(vector: Vector, matrix2: 'Matrix', /) -> None\n"
        "\n"
    ...
    {"setCol",
        ...
        METH_VARARGS,
        "setCol($self, index, vector, /)\n"
        "--\n"
        "\n"
        "setCol(index: int, vector: Vector, /) -> None\n"
        "\n"
    ...
    {"setRow",
        ...
        METH_VARARGS,
        "setRow($self, index, vector, /)\n"
        "--\n"
        "\n"
        "setRow(index: int, vector: Vector, /) -> None\n"
        "\n"
    ...
    {"setDiagonal",
        ...
        METH_VARARGS,
        "setDiagonal($self, vector, /)\n"
        "--\n"
        "\n"
        "setDiagonal(vector: Vector, /) -> None\n"
        "\n"
    ...
    {"isOrthogonal",
        ...
        METH_VARARGS,
        "isOrthogonal($self, tol=1e-06, /)\n"
        "--\n"
        "\n"
        "isOrthogonal(tol: float=1e-06, /) -> float\n"
        "\n"
...
Matrix4D *MatrixPy::getTwinPtr() const
{
    return getMatrixPtr();
}
