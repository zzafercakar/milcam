...
PyTypeObject QuantityPy::Type = {
    ...
    .tp_name = "Base.Quantity",
    .tp_basicsize = sizeof(QuantityPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_number = Base::QuantityPy::Number,
    ...
    .tp_richcompare = Base::QuantityPy::richCompare,
    .tp_methods = Base::QuantityPy::Methods,
    .tp_getset = Base::QuantityPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::QuantityPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef QuantityPy::Methods[] = {
    ...
    {"getUserPreferred",
        ...
        METH_VARARGS,
        "getUserPreferred($self)\n"
        "--\n"
        "\n"
        "getUserPreferred() -> Tuple['Quantity', str]\n"
        "\n"
    ...
    {"getValueAs",
        ...
        METH_VARARGS,
        "getValueAs($self, *args)\n"
        "--\n"
        "\n"
        "getValueAs(unit: str, /) -> float\n"
        "getValueAs(translation: float, unit_signature: int, /) -> float\n"
        "getValueAs(unit: UnitPy, /) -> float\n"
        "getValueAs(quantity: 'Quantity', /) -> float\n"
        "\n"
...
Quantity *QuantityPy::getTwinPtr() const
{
