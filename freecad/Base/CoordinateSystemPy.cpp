...
PyMethodDef CoordinateSystemPy::Methods[] = {
    {"setAxes",
        ...
        METH_VARARGS,
        "setAxes($self, axis, xDir, /)\n"
        "--\n"
        "\n"
        "setAxes(axis: Union[AxisPy, Vector], xDir: Vector, /) -> None\n"
        "\n"
    ...
    {"displacement",
        ...
        METH_VARARGS,
        "displacement($self, coordSystem2, /)\n"
        "--\n"
        "\n"
        "displacement(coordSystem2: 'CoordinateSystem', /) -> Placement\n"
        "\n"
    ...
    {"transformTo",
        ...
        METH_VARARGS,
        "transformTo($self, vector, /)\n"
        "--\n"
        "\n"
        "transformTo(vector: Vector, /) -> Vector\n"
        "\n"
    ...
    {"transform",
        ...
        "--\n"
        "\n"
        "transform(trans: Union[Rotation, Placement], /) -> None\n"
        "\n"
    ...
    {"setPlacement",
        ...
        METH_VARARGS,
        "setPlacement($self, placement, /)\n"
        "--\n"
        "\n"
        "setPlacement(placement: Placement, /) -> None\n"
        "\n"
...
CoordinateSystem *CoordinateSystemPy::getTwinPtr() const
{
    return getCoordinateSystemPtr();
}
