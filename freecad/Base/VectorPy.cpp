...
PyTypeObject VectorPy::Type = {
    ...
    .tp_name = "Base.Vector",
    .tp_basicsize = sizeof(VectorPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_number = Base::VectorPy::Number,
    .tp_as_sequence = Base::VectorPy::Sequence,
    .tp_as_mapping = Base::VectorPy::Mapping,
    .tp_getattro = __getattro,
    .tp_setattro = __setattro,
    /* --- Flags to define presence of optional/expanded features */
    .tp_flags = Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT,
    .tp_doc = "Base.Vector class.\n"
    "\n"
    ...
    .tp_richcompare = Base::VectorPy::richCompare,
    .tp_methods = Base::VectorPy::Methods,
    .tp_getset = Base::VectorPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::VectorPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef VectorPy::Methods[] = {
    ...
    {"distanceToLine",
        ...
        METH_VARARGS,
        "distanceToLine($self, base, dir, /)\n"
        "--\n"
        "\n"
        "distanceToLine(base: 'Vector', dir: 'Vector', /) -> float\n"
        "\n"
    ...
    {"distanceToLineSegment",
        ...
        METH_VARARGS,
        "distanceToLineSegment($self, point1, point2, /)\n"
        "--\n"
        "\n"
        "distanceToLineSegment(point1: 'Vector', point2: 'Vector', /) -> 'Vector'\n"
        "\n"
...
Vector3d *VectorPy::getTwinPtr() const
{
    return getVectorPtr();
}
