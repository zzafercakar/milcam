...
PyMethodDef TypePy::Methods[] = {
    ...
    {"getAllDerivedFrom",
        ...
        METH_VARARGS|METH_STATIC,
        "getAllDerivedFrom(type, /)\n"
        "--\n"
        "\n"
        "getAllDerivedFrom(type: str, /) -> List[str]\n"
        "\n"
    ...
    {"isDerivedFrom",
        ...
        METH_VARARGS,
        "isDerivedFrom($self, type, /)\n"
        "--\n"
        "\n"
        "isDerivedFrom(type: str, /) -> bool\n"
        "\n"
    ...
    {"createInstanceByName",
        ...
        METH_VARARGS|METH_STATIC,
        "createInstanceByName(name, load=False, /)\n"
        "--\n"
        "\n"
        "createInstanceByName(name: str, load: bool=False, /) -> object\n"
        "\n"
...
BaseType *TypePy::getTwinPtr() const
{
    return getBaseTypePtr();
}
