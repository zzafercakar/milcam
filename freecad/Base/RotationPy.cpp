...
PyTypeObject RotationPy::Type = {
    ...
    .tp_name = "Base.Rotation",
    .tp_basicsize = sizeof(RotationPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_number = Base::RotationPy::Number,
    .tp_getattro = __getattro,
    .tp_setattro = __setattro,
    /* --- Flags to define presence of optional/expanded features */
    .tp_flags = Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT,
    .tp_doc = "Base.Rotation class.\n"
    "\n"
    ...
    .tp_richcompare = Base::RotationPy::richCompare,
    .tp_methods = Base::RotationPy::Methods,
    .tp_getset = Base::RotationPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::RotationPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef RotationPy::Methods[] = {
    ...
    {"isSame",
        ...
        METH_VARARGS,
        "isSame($self, rotation, tol=0, /)\n"
        "--\n"
        "\n"
        "isSame(rotation: 'Rotation', tol: float=0, /) -> bool\n"
        "\n"
    ...
    {"slerp",
        ...
        METH_VARARGS,
        "slerp($self, rotation2, t, /)\n"
        "--\n"
        "\n"
        "slerp(rotation2: 'Rotation', t: float, /) -> 'Rotation'\n"
        "\n"
    ...
    {"setYawPitchRoll",
        ...
        METH_VARARGS,
        "setYawPitchRoll($self, angle1, angle2, angle3, /)\n"
        "--\n"
        "\n"
        "setYawPitchRoll(angle1: float, angle2: float, angle3: float, /) -> None\n"
        "\n"
    ...
    {"setEulerAngles",
        ...
        METH_VARARGS,
        "setEulerAngles($self, seq, angle1, angle2, angle3, /)\n"
        "--\n"
        "\n"
        "setEulerAngles(seq: str, angle1: float, angle2: float, angle3: float, /) -> None\n"
        "\n"
    ...
    {"toEulerAngles",
        ...
        METH_VARARGS,
        "toEulerAngles($self, seq='', /)\n"
        "--\n"
        "\n"
        "toEulerAngles(seq: str='', /) -> List[float]\n"
        "\n"
    ...
    {"isIdentity",
        ...
        METH_VARARGS,
        "isIdentity($self, tol=0, /)\n"
        "--\n"
        "\n"
        "isIdentity(tol: float=0, /) -> bool\n"
        "\n"
...
Rotation *RotationPy::getTwinPtr() const
{
