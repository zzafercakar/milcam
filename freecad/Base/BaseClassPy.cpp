...
PyTypeObject BaseClassPy::Type = {
    ...
    .tp_name = "Base.BaseClass",
    .tp_basicsize = sizeof(BaseClassPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This is the base class",
    .tp_methods = Base::BaseClassPy::Methods,
    .tp_getset = Base::BaseClassPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Base::BaseClassPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef BaseClassPy::Methods[] = {
    {"isDerivedFrom",
        ...
        METH_VARARGS,
        "isDerivedFrom($self, typeName, /)\n"
        "--\n"
        "\n"
        "isDerivedFrom(typeName: str, /) -> bool\n"
        "\n"
    ...
    {"getAllDerivedFrom",
        ...
        METH_VARARGS,
        "getAllDerivedFrom($self)\n"
        "--\n"
        "\n"
        "getAllDerivedFrom() -> List[object]\n"
        "\n"
...
BaseClass *BaseClassPy::getTwinPtr() const
{
    return getBaseClassPtr();
}
