...
PyMethodDef PlateSurfacePy::Methods[] = {
    {"makeApprox",
        ...
        "makeApprox($self, *, Tol3d=0, MaxSegments=0, MaxDegree=0, MaxDistance=0, CritOrder=0, Continuity='', EnlargeCoeff=0)\n"
        "--\n"
        "\n"
        "makeApprox(*, Tol3d: float=0, MaxSegments: int=0, MaxDegree: int=0, MaxDistance: float=0, CritOrder: int=0, Continuity: str='', EnlargeCoeff: float=0) -> None\n"
        "\n"
...
GeomPlateSurface *PlateSurfacePy::getTwinPtr() const
{
    return getGeomPlateSurfacePtr();
}
