...
PyTypeObject HLRBRep_PolyAlgoPy::Type = {
    ...
    .tp_name = "Part.HLRBRep_PolyAlgo",
    .tp_basicsize = sizeof(HLRBRep_PolyAlgoPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "PolyAlgo() -> HLRBRep_PolyAlgo\n"
    "\n"
    ...
    "  same shape.",
    .tp_methods = Part::HLRBRep_PolyAlgoPy::Methods,
    .tp_getset = Part::HLRBRep_PolyAlgoPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::HLRBRep_PolyAlgoPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef HLRBRep_PolyAlgoPy::Methods[] = {
    ...
    {"setProjector",
        ...
        "setProjector($self, Origin=(0.0, 0.0, 0.0), ZDir=(0.0, 0.0, 0.0), XDir=(0.0, 0.0, 0.0), focus=float('nan'))\n"
        "--\n"
        "\n"
        "setProjector(Origin: tuple[float, float, float]=(0.0, 0.0, 0.0), ZDir: tuple[float, float, float]=(0.0, 0.0, 0.0), XDir: tuple[float, float, float]=(0.0, 0.0, 0.0), focus: float=float('nan')) -> None\n"
        "\n"
    ...
    {"outLinedShape",
        ...
        METH_VARARGS,
        "outLinedShape($self, S, /)\n"
        "--\n"
        "\n"
        "outLinedShape(S: TopoShape, /) -> TopoShape\n"
        "\n"
...
HLRBRep_PolyAlgo *HLRBRep_PolyAlgoPy::getTwinPtr() const
{
    return getHLRBRep_PolyAlgoPtr();
}
