...
PyTypeObject HLRBRep_AlgoPy::Type = {
    ...
    .tp_name = "Part.HLRBRep_Algo",
    .tp_basicsize = sizeof(HLRBRep_AlgoPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    "  same shape.",
    .tp_methods = Part::HLRBRep_AlgoPy::Methods,
    .tp_getset = Part::HLRBRep_AlgoPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::HLRBRep_AlgoPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef HLRBRep_AlgoPy::Methods[] = {
    ...
    {"setProjector",
        ...
        "setProjector($self, Origin=(0, 0, 0), ZDir=(0, 0, 0), XDir=(0, 0, 0), focus=float('nan'))\n"
        "--\n"
        "\n"
        "setProjector(Origin: tuple[float, float, float]=(0, 0, 0), ZDir: tuple[float, float, float]=(0, 0, 0), XDir: tuple[float, float, float]=(0, 0, 0), focus: float=float('nan')) -> None\n"
        "\n"
...
HLRBRep_Algo *HLRBRep_AlgoPy::getTwinPtr() const
{
    return getHLRBRep_AlgoPtr();
}
