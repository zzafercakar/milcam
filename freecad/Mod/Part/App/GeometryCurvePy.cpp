...
PyTypeObject GeometryCurvePy::Type = {
    ...
    .tp_name = "Part.Curve",
    .tp_basicsize = sizeof(GeometryCurvePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "The abstract class GeometryCurve is the root class of all curve objects.",
    .tp_methods = Part::GeometryCurvePy::Methods,
    .tp_getset = Part::GeometryCurvePy::GetterSetter,
    .tp_base = &Part::GeometryPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::GeometryCurvePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef GeometryCurvePy::Methods[] = {
    ...
    {"discretize",
        ...
        "--\n"
        "\n"
        "discretize(Number: int, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "discretize(QuasiNumber: int, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "discretize(Distance: float, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "discretize(Deflection: float, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "discretize(QuasiDeflection: float, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "discretize(Angular: float, Curvature: float, Minimum: int=2, *, First: Optional[float]=None, Last: Optional[float]=None) -> List[Vector]\n"
        "\n"
    ...
    {"getD0",
        ...
        METH_VARARGS,
        "getD0($self, parameter, /)\n"
        "--\n"
        "\n"
        "getD0(parameter: float, /) -> Vector\n"
        "\n"
    ...
    {"getD1",
        ...
        METH_VARARGS,
        "getD1($self, parameter, /)\n"
        "--\n"
        "\n"
        "getD1(parameter: float, /) -> Vector\n"
        "\n"
    ...
    {"getD2",
        ...
        METH_VARARGS,
        "getD2($self, parameter, /)\n"
        "--\n"
        "\n"
        "getD2(parameter: float, /) -> Vector\n"
        "\n"
    ...
    {"getD3",
        ...
        METH_VARARGS,
        "getD3($self, parameter, /)\n"
        "--\n"
        "\n"
        "getD3(parameter: float, /) -> Vector\n"
        "\n"
    ...
    {"getDN",
        ...
        METH_VARARGS,
        "getDN($self, n, parameter, /)\n"
        "--\n"
        "\n"
        "getDN(n: int, parameter: float, /) -> Vector\n"
        "\n"
    ...
    {"length",
        ...
        METH_VARARGS,
        "length($self, uMin=None, uMax=None, Tol=None, /)\n"
        "--\n"
        "\n"
        "length(uMin: Optional[float]=None, uMax: Optional[float]=None, Tol: Optional[float]=None, /) -> float\n"
        "\n"
    ...
    {"parameterAtDistance",
        ...
        METH_VARARGS,
        "parameterAtDistance($self, abscissa=None, startingParameter=None, /)\n"
        "--\n"
        "\n"
        "parameterAtDistance(abscissa: Optional[float]=None, startingParameter: Optional[float]=None, /) -> float\n"
        "\n"
    ...
    {"makeRuledSurface",
        ...
        METH_VARARGS,
        "makeRuledSurface($self, otherCurve, /)\n"
        "--\n"
        "\n"
        "makeRuledSurface(otherCurve: 'GeometryCurve', /) -> object\n"
        "\n"
    ...
    {"intersect2d",
        ...
        METH_VARARGS,
        "intersect2d($self, otherCurve, /)\n"
        "--\n"
        "\n"
        "intersect2d(otherCurve: 'GeometryCurve', /) -> List[Vector]\n"
        "\n"
    ...
    {"continuityWith",
        ...
        METH_VARARGS,
        "continuityWith($self, otherCurve, /)\n"
        "--\n"
        "\n"
        "continuityWith(otherCurve: 'GeometryCurve', /) -> str\n"
        "\n"
    ...
    {"parameter",
        ...
        METH_VARARGS,
        "parameter($self, point, /)\n"
        "--\n"
        "\n"
        "parameter(point: Vector, /) -> float\n"
        "\n"
    ...
    {"projectPoint",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "projectPoint($self, **kwargs)\n"
        "--\n"
        "\n"
        "projectPoint(Point: Vector, Method: str='NearestPoint') -> Vector\n"
        "projectPoint(Point: Vector, Method: str='LowerDistance') -> float\n"
        "projectPoint(Point: Vector, Method: str='LowerDistanceParameter') -> float\n"
        "projectPoint(Point: Vector, Method: str='Distance') -> List[float]\n"
        "projectPoint(Point: Vector, Method: str='Parameter') -> List[float]\n"
        "projectPoint(Point: Vector, Method: str='Point') -> List[Vector]\n"
        "\n"
    ...
    {"centerOfCurvature",
        ...
        METH_VARARGS,
        "centerOfCurvature($self, pos, /)\n"
        "--\n"
        "\n"
        "centerOfCurvature(pos: float, /) -> Vector\n"
        "\n"
    ...
    {"intersect",
        ...
        METH_VARARGS,
        "intersect($self, curve_or_surface, precision, /)\n"
        "--\n"
        "\n"
        "intersect(curve_or_surface: object, precision: float, /) -> object\n"
        "\n"
    ...
    {"intersectCS",
        ...
        METH_VARARGS,
        "intersectCS($self, surface, /)\n"
        "--\n"
        "\n"
        "intersectCS(surface: object, /) -> object\n"
        "\n"
    ...
    {"intersectCC",
        ...
        METH_VARARGS,
        "intersectCC($self, otherCurve, /)\n"
        "--\n"
        "\n"
        "intersectCC(otherCurve: 'GeometryCurve', /) -> List[Vector]\n"
        "\n"
    ...
    {"toBSpline",
        ...
        METH_VARARGS,
        "toBSpline($self, points, /)\n"
        "--\n"
        "\n"
        "toBSpline(points: Tuple[float, float], /) -> BSplineCurve\n"
        "\n"
    ...
    {"toNurbs",
        ...
        "--\n"
        "\n"
        "toNurbs(points: Tuple[float, float], /) -> BSplineCurve\n"
        "\n"
    ...
    {"trim",
        ...
        "--\n"
        "\n"
        "trim(points: Tuple[float, float], /) -> TrimmedCurve\n"
        "\n"
    ...
    {"approximateBSpline",
        ...
        METH_VARARGS,
        "approximateBSpline($self, Tolerance, MaxSegments, MaxDegree, Order='C2', /)\n"
        "--\n"
        "\n"
        "approximateBSpline(Tolerance: float, MaxSegments: int, MaxDegree: int, Order: str='C2', /) -> BSplineCurve\n"
        "\n"
    ...
    {"reversedParameter",
        ...
        METH_VARARGS,
        "reversedParameter($self, U, /)\n"
        "--\n"
        "\n"
        "reversedParameter(U: float, /) -> float\n"
        "\n"
...
GeomCurve *GeometryCurvePy::getTwinPtr() const
{
    return getGeomCurvePtr();
}
