...
PyTypeObject BRepOffsetAPI_MakePipeShellPy::Type = {
    ...
    .tp_name = "Part.BRepOffsetAPI_MakePipeShell",
    .tp_basicsize = sizeof(BRepOffsetAPI_MakePipeShellPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Low level API to create a PipeShell using OCC API\n"
    "\n"
    "Ref: https://dev.opencascade.org/doc/refman/html/class_b_rep_offset_a_p_i___make_pipe_shell.html",
    .tp_methods = Part::BRepOffsetAPI_MakePipeShellPy::Methods,
    .tp_getset = Part::BRepOffsetAPI_MakePipeShellPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BRepOffsetAPI_MakePipeShellPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef BRepOffsetAPI_MakePipeShellPy::Methods[] = {
    {"setFrenetMode",
        ...
        METH_VARARGS,
        "setFrenetMode($self, mode, /)\n"
        "--\n"
        "\n"
        "setFrenetMode(mode: bool, /) -> None\n"
        "\n"
    ...
    {"setTrihedronMode",
        ...
        METH_VARARGS,
        "setTrihedronMode($self, point, direction, /)\n"
        "--\n"
        "\n"
        "setTrihedronMode(point: Vector, direction: Vector, /) -> None\n"
        "\n"
    ...
    {"setBiNormalMode",
        ...
        METH_VARARGS,
        "setBiNormalMode($self, direction, /)\n"
        "--\n"
        "\n"
        "setBiNormalMode(direction: Vector, /) -> None\n"
        "\n"
    ...
    {"setSpineSupport",
        ...
        METH_VARARGS,
        "setSpineSupport($self, shape, /)\n"
        "--\n"
        "\n"
        "setSpineSupport(shape: TopoShape, /) -> None\n"
        "\n"
    ...
    {"setAuxiliarySpine",
        ...
        METH_VARARGS,
        "setAuxiliarySpine($self, wire, CurvilinearEquivalence, TypeOfContact, /)\n"
        "--\n"
        "\n"
        "setAuxiliarySpine(wire: TopoShape, CurvilinearEquivalence: bool, TypeOfContact: int, /) -> None\n"
        "\n"
    ...
    {"add",
        ...
        "--\n"
        "\n"
        "add(Profile: TopoShape, *, WithContact: bool=False, WithCorrection: bool=False) -> None\n"
        "add(Profile: TopoShape, Location: TopoShape, *, WithContact: bool=False, WithCorrection: bool=False) -> None\n"
        "\n"
    ...
    {"setTolerance",
        ...
        METH_VARARGS,
        "setTolerance($self, tol3d, boundTol, tolAngular, /)\n"
        "--\n"
        "\n"
        "setTolerance(tol3d: float, boundTol: float, tolAngular: float, /) -> None\n"
        "\n"
    ...
    {"setTransitionMode",
        ...
        METH_VARARGS,
        "setTransitionMode($self, mode, /)\n"
        "--\n"
        "\n"
        "setTransitionMode(mode: int, /) -> None\n"
        "\n"
    ...
    {"generated",
        ...
        "--\n"
        "\n"
        "generated(S: TopoShape, /) -> list[TopoShape]\n"
        "\n"
        "generated(shape S)\n"
    ...
    {"setMaxDegree",
        ...
        METH_VARARGS,
        "setMaxDegree($self, degree, /)\n"
        "--\n"
        "\n"
        "setMaxDegree(degree: int, /) -> None\n"
        "\n"
    ...
    {"setMaxSegments",
        ...
        METH_VARARGS,
        "setMaxSegments($self, num, /)\n"
        "--\n"
        "\n"
        "setMaxSegments(num: int, /) -> None\n"
        "\n"
    ...
    {"setForceApproxC1",
        ...
        METH_VARARGS,
        "setForceApproxC1($self, flag, /)\n"
        "--\n"
        "\n"
        "setForceApproxC1(flag: bool, /) -> None\n"
        "\n"
...
BRepOffsetAPI_MakePipeShell *BRepOffsetAPI_MakePipeShellPy::getTwinPtr() const
{
    return getBRepOffsetAPI_MakePipeShellPtr();
}
