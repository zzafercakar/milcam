...
PyTypeObject ArcOfCircle2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.ArcOfCircle2d",
    .tp_basicsize = sizeof(ArcOfCircle2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Part::ArcOfCircle2dPy::Methods,
    .tp_getset = Part::ArcOfCircle2dPy::GetterSetter,
    .tp_base = &Part::ArcOfConic2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ArcOfCircle2dPy::PyMake
};
#if defined(__GNUC__)
...
Geom2dArcOfCircle *ArcOfCircle2dPy::getTwinPtr() const
{
    return getGeom2dArcOfCirclePtr();
}
