...
PyTypeObject Curve2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.Curve2d",
    .tp_basicsize = sizeof(Curve2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "The abstract class Geom2dCurve is the root class of all curve objects.",
    .tp_methods = Part::Curve2dPy::Methods,
    .tp_getset = Part::Curve2dPy::GetterSetter,
    .tp_base = &Part::Geometry2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::Curve2dPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef Curve2dPy::Methods[] = {
    ...
    {"discretize",
        ...
        "--\n"
        "\n"
        "discretize(*, Number: int) -> List[Vector]\n"
        "discretize(*, QuasiNumber: int) -> List[Vector]\n"
        "discretize(*, Distance: float) -> List[Vector]\n"
        "discretize(*, Deflection: float) -> List[Vector]\n"
        "discretize(*, QuasiDeflection: float) -> List[Vector]\n"
        "discretize(*, Angular: float, Curvature: float, Minimum: int=2) -> List[Vector]\n"
        "\n"
    ...
    {"length",
        ...
        "\n"
        "length(/) -> float\n"
        "length(uMin: float, /) -> float\n"
        "length(uMin: float, uMax: float, /) -> float\n"
        "length(uMin: float, uMax: float, Tol: float, /) -> float\n"
        "\n"
    ...
    {"parameterAtDistance",
        ...
        METH_VARARGS,
        "parameterAtDistance($self, *args)\n"
        "--\n"
        "\n"
        "parameterAtDistance(abscissa: float, /) -> float\n"
        "parameterAtDistance(abscissa: float, startingParameter: float, /) -> float\n"
        "\n"
    ...
    {"intersectCC",
        ...
        METH_VARARGS,
        "intersectCC($self, other, /)\n"
        "--\n"
        "\n"
        "intersectCC(other: 'Curve2d', /) -> List[Vector]\n"
        "\n"
...
Geom2dCurve *Curve2dPy::getTwinPtr() const
{
    return getGeom2dCurvePtr();
}
