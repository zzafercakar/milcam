...
PyMethodDef BezierCurve2dPy::Methods[] = {
    ...
    {"increase",
        ...
        METH_VARARGS,
        "increase($self, Degree, /)\n"
        "--\n"
        "\n"
        "increase(Degree: int, /) -> None\n"
        "\n"
        "increase(Int=Degree)\n"
    ...
    {"setPole",
        ...
        METH_VARARGS,
        "setPole($self, index, pole, /)\n"
        "--\n"
        "\n"
        "setPole(index: int, pole: object, /) -> None\n"
        "\n"
    ...
    {"setPoles",
        ...
        "--\n"
        "\n"
        "setPoles(poles: List[object], /) -> None\n"
        "\n"
    ...
    {"setWeight",
        ...
        "--\n"
        "\n"
        "setWeight(index: int, weight: float, /) -> None\n"
        "\n"
...
Geom2dBezierCurve *BezierCurve2dPy::getTwinPtr() const
{
    return getGeom2dBezierCurvePtr();
}
