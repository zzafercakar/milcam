...
PyTypeObject BSplineCurve2dPy::Type = {
    ...
    .tp_name = "Part.Geom2d.BSplineCurve2d",
    .tp_basicsize = sizeof(BSplineCurve2dPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Part::BSplineCurve2dPy::Methods,
    .tp_getset = Part::BSplineCurve2dPy::GetterSetter,
    .tp_base = &Part::Curve2dPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BSplineCurve2dPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef BSplineCurve2dPy::Methods[] = {
    ...
    {"removeKnot",
        ...
        "--\n"
        "\n"
        "removeKnot(Index: int, M: int, tol: float, /) -> None\n"
        "\n"
    ...
    {"getPolesAndWeights",
        ...
        "--\n"
        "\n"
        "getPolesAndWeights() -> tuple[list[Vector], list[float]]\n"
        "\n"
    ...
    {"getCardinalSplineTangents",
        ...
        "--\n"
        "\n"
        "getCardinalSplineTangents(**kwargs) -> None\n"
        "\n"
    ...
    {"buildFromPoles",
        ...
        METH_VARARGS,
        "buildFromPoles($self, poles, /)\n"
        "--\n"
        "\n"
        "buildFromPoles(poles: list[Vector], /) -> None\n"
        "\n"
    ...
    {"buildFromPolesMultsKnots",
        ...
        "--\n"
        "\n"
        "buildFromPolesMultsKnots(poles: list[Vector], mults: tuple[int, ...], knots: tuple[float, ...], periodic: bool, degree: int) -> None\n"
        "buildFromPolesMultsKnots(poles: list[Vector], mults: tuple[int, ...], knots: tuple[float, ...], periodic: bool, degree: int, weights: tuple[float, ...], CheckRational: bool) -> None\n"
        "\n"
    ...
    {"join",
        ...
        "--\n"
        "\n"
        "join(other: 'BSplineCurve2d', /) -> 'BSplineCurve2d'\n"
        "\n"
    ...
    {"makeC1Continuous",
        ...
        "--\n"
        "\n"
        "makeC1Continuous(tol: float=1e-06, ang_tol: float=1e-07, /) -> 'BSplineCurve2d'\n"
        "\n"
...
Geom2dBSplineCurve *BSplineCurve2dPy::getTwinPtr() const
{
    return getGeom2dBSplineCurvePtr();
}
