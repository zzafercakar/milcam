...
PyTypeObject TopoShapeVertexPy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeVertexPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "TopoShapeVertex is the OpenCasCade topological vertex wrapper",
    .tp_methods = Part::TopoShapeVertexPy::Methods,
    .tp_getset = Part::TopoShapeVertexPy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeVertexPy::PyMake
};
#if defined(__GNUC__)
...
TopoShape *TopoShapeVertexPy::getTwinPtr() const
{
