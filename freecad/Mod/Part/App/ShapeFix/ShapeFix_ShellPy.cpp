...
PyMethodDef ShapeFix_ShellPy::Methods[] = {
    ...
    {"fixFaceOrientation",
        ...
        METH_VARARGS,
        "fixFaceOrientation($self)\n"
        "--\n"
        "\n"
        "fixFaceOrientation() -> None\n"
        "\n"
    ...
    {"setNonManifoldFlag",
        ...
        METH_VARARGS,
        "setNonManifoldFlag($self)\n"
        "--\n"
        "\n"
        "setNonManifoldFlag() -> None\n"
        "\n"
...
ShapeFix_Shell *ShapeFix_ShellPy::getTwinPtr() const
{
    return getShapeFix_ShellPtr();
}
