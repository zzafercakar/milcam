...
PyTypeObject ShapeFix_FacePy::Type = {
    ...
    .tp_name = "Part.ShapeFix.Face",
    .tp_basicsize = sizeof(ShapeFix_FacePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Part::ShapeFix_FacePy::Methods,
    .tp_getset = Part::ShapeFix_FacePy::GetterSetter,
    .tp_base = &Part::ShapeFix_RootPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ShapeFix_FacePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef ShapeFix_FacePy::Methods[] = {
    ...
    {"fixAddNaturalBound",
        ...
        METH_VARARGS,
        "fixAddNaturalBound($self)\n"
        "--\n"
        "\n"
        "fixAddNaturalBound() -> bool\n"
        "\n"
    ...
    {"fixSmallAreaWire",
        ...
        METH_VARARGS,
        "fixSmallAreaWire($self)\n"
        "--\n"
        "\n"
        "fixSmallAreaWire() -> bool\n"
        "\n"
    ...
    {"fixIntersectingWires",
        ...
        METH_VARARGS,
        "fixIntersectingWires($self)\n"
        "--\n"
        "\n"
        "fixIntersectingWires() -> None\n"
        "\n"
    ...
    {"fixWiresTwoCoincidentEdges",
        ...
        METH_VARARGS,
        "fixWiresTwoCoincidentEdges($self)\n"
        "--\n"
        "\n"
        "fixWiresTwoCoincidentEdges() -> None\n"
        "\n"
    ...
    {"fixPeriodicDegenerated",
        ...
        METH_VARARGS,
        "fixPeriodicDegenerated($self)\n"
        "--\n"
        "\n"
        "fixPeriodicDegenerated() -> None\n"
        "\n"
    ...
    {"result",
        ...
        "--\n"
        "\n"
        "result() -> Union[TopoShapeFace, TopoShapeShell]\n"
        "\n"
...
ShapeFix_Face *ShapeFix_FacePy::getTwinPtr() const
{
    return getShapeFix_FacePtr();
}
