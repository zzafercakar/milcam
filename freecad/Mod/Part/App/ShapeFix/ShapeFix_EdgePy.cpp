...
PyTypeObject ShapeFix_EdgePy::Type = {
    ...
    .tp_name = "Part.ShapeFix.Edge",
    .tp_basicsize = sizeof(ShapeFix_EdgePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Fixing invalid edge",
    .tp_methods = Part::ShapeFix_EdgePy::Methods,
    .tp_getset = Part::ShapeFix_EdgePy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ShapeFix_EdgePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef ShapeFix_EdgePy::Methods[] = {
    {"fixRemovePCurve",
        ...
        METH_VARARGS,
        "fixRemovePCurve($self)\n"
        "--\n"
        "\n"
        "fixRemovePCurve() -> bool\n"
        "\n"
    ...
    {"fixRemoveCurve3d",
        ...
        METH_VARARGS,
        "fixRemoveCurve3d($self)\n"
        "--\n"
        "\n"
        "fixRemoveCurve3d() -> bool\n"
        "\n"
    ...
    {"fixVertexTolerance",
        ...
        METH_VARARGS,
        "fixVertexTolerance($self)\n"
        "--\n"
        "\n"
        "fixVertexTolerance() -> bool\n"
        "\n"
    ...
    {"fixSameParameter",
        ...
        METH_VARARGS,
        "fixSameParameter($self)\n"
        "--\n"
        "\n"
        "fixSameParameter() -> bool\n"
        "\n"
...
ShapeFix_Edge *ShapeFix_EdgePy::getTwinPtr() const
{
    return getShapeFix_EdgePtr();
}
