...
PyTypeObject ShapeFix_FreeBoundsPy::Type = {
    ...
    .tp_name = "Part.ShapeFix.FreeBounds",
    .tp_basicsize = sizeof(ShapeFix_FreeBoundsPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This class is intended to output free bounds of the shape",
    .tp_methods = Part::ShapeFix_FreeBoundsPy::Methods,
    .tp_getset = Part::ShapeFix_FreeBoundsPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ShapeFix_FreeBoundsPy::PyMake
};
#if defined(__GNUC__)
...
ShapeFix_FreeBounds *ShapeFix_FreeBoundsPy::getTwinPtr() const
{
    return getShapeFix_FreeBoundsPtr();
}
