...
PyTypeObject ShapeFix_WireframePy::Type = {
    ...
    .tp_name = "Part.ShapeFix.Wireframe",
    .tp_basicsize = sizeof(ShapeFix_WireframePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Provides methods for fixing wireframe of shape",
    .tp_methods = Part::ShapeFix_WireframePy::Methods,
    .tp_getset = Part::ShapeFix_WireframePy::GetterSetter,
    .tp_base = &Part::ShapeFix_RootPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ShapeFix_WireframePy::PyMake
};
#if defined(__GNUC__)
...
ShapeFix_Wireframe *ShapeFix_WireframePy::getTwinPtr() const
{
    return getShapeFix_WireframePtr();
}
