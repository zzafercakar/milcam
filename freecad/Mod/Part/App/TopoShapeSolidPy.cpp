...
PyTypeObject TopoShapeSolidPy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeSolidPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Part.Solid(shape): Create a solid out of shells of shape. If shape is a compsolid, the overall volume solid is created.",
    .tp_methods = Part::TopoShapeSolidPy::Methods,
    .tp_getset = Part::TopoShapeSolidPy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeSolidPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapeSolidPy::Methods[] = {
    {"getMomentOfInertia",
        ...
        METH_VARARGS,
        "getMomentOfInertia($self, point, direction, /)\n"
        "--\n"
        "\n"
        "getMomentOfInertia(point: Vector, direction: Vector, /) -> float\n"
        "\n"
    ...
    {"getRadiusOfGyration",
        ...
        METH_VARARGS,
        "getRadiusOfGyration($self, point, direction, /)\n"
        "--\n"
        "\n"
        "getRadiusOfGyration(point: Vector, direction: Vector, /) -> float\n"
        "\n"
    ...
    {"offsetFaces",
        ...
        METH_VARARGS,
        "offsetFaces($self, *args, **kwargs)\n"
        "--\n"
        "\n"
        "offsetFaces(facesTuple: Tuple[TopoShape, ...], offset: float, /) -> TopoShape\n"
        "offsetFaces(facesDict: Dict[TopoShape, float], /) -> TopoShape\n"
        "\n"
        "Example:\n"
...
TopoShape *TopoShapeSolidPy::getTwinPtr() const
{
