...
public:
    ...
    PyObject*  getMomentOfInertia(PyObject *args) const;
    ...
    PyObject*  getRadiusOfGyration(PyObject *args) const;
    ...
    PyObject*  offsetFaces(PyObject *args) const;
    //@}
