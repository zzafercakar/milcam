...
PyMethodDef AttachExtensionPy::Methods[] = {
    ...
    {"changeAttacherType",
        ...
        METH_VARARGS,
        "changeAttacherType($self, typename, /)\n"
        "--\n"
        "\n"
        "changeAttacherType(typename: str, /) -> None\n"
        "\n"
...
AttachExtension *AttachExtensionPy::getTwinPtr() const
{
    return getAttachExtensionPtr();
}
