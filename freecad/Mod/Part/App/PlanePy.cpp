...
PyTypeObject PlanePy::Type = {
    ...
    .tp_doc = "Describes an infinite plane\n"
    ...
    "    Ax+By+Cz+D=0",
    .tp_methods = Part::PlanePy::Methods,
    .tp_getset = Part::PlanePy::GetterSetter,
    .tp_base = &Part::GeometrySurfacePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::PlanePy::PyMake
};
#if defined(__GNUC__)
...
GeomPlane *PlanePy::getTwinPtr() const
{
    return getGeomPlanePtr();
}
