...
PyTypeObject MakePrismPy::Type = {
    ...
    .tp_name = "Part.BRepFeat.MakePrism",
    .tp_basicsize = sizeof(MakePrismPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes functions to build prism features.",
    .tp_methods = Part::MakePrismPy::Methods,
    .tp_getset = Part::MakePrismPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::MakePrismPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef MakePrismPy::Methods[] = {
    ...
    {"performUntilEnd",
        ...
        METH_VARARGS,
        "performUntilEnd($self)\n"
        "--\n"
        "\n"
        "performUntilEnd() -> None\n"
        "\n"
    ...
    {"performUntilHeight",
        ...
        METH_VARARGS,
        "performUntilHeight($self)\n"
        "--\n"
        "\n"
        "performUntilHeight() -> None\n"
        "\n"
...
BRepFeat_MakePrism *MakePrismPy::getTwinPtr() const
{
    return getBRepFeat_MakePrismPtr();
}
