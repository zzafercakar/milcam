...
PyTypeObject CurveConstraintPy::Type = {
    ...
    .tp_name = "Part.GeomPlate.CurveConstraintPy",
    .tp_basicsize = sizeof(CurveConstraintPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Defines curves as constraints to be used to deform a surface",
    .tp_methods = Part::CurveConstraintPy::Methods,
    .tp_getset = Part::CurveConstraintPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::CurveConstraintPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef CurveConstraintPy::Methods[] = {
    ...
    {"setCurve2dOnSurf",
        ...
        METH_VARARGS,
        "setCurve2dOnSurf($self)\n"
        "--\n"
        "\n"
        "setCurve2dOnSurf() -> None\n"
        "\n"
    ...
    {"setProjectedCurve",
        ...
        METH_VARARGS,
        "setProjectedCurve($self)\n"
        "--\n"
        "\n"
        "setProjectedCurve() -> None\n"
        "\n"
...
GeomPlate_CurveConstraint *CurveConstraintPy::getTwinPtr() const
{
    return getGeomPlate_CurveConstraintPtr();
}
