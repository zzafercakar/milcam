...
PyTypeObject PointConstraintPy::Type = {
    ...
    .tp_name = "Part.GeomPlate.PointConstraintPy",
    .tp_basicsize = sizeof(PointConstraintPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Defines points as constraints to be used to deform a surface",
    .tp_methods = Part::PointConstraintPy::Methods,
    .tp_getset = Part::PointConstraintPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::PointConstraintPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef PointConstraintPy::Methods[] = {
    ...
    {"setG0Criterion",
        ...
        METH_VARARGS,
        "setG0Criterion($self, value, /)\n"
        "--\n"
        "\n"
        "setG0Criterion(value: float, /) -> None\n"
        "\n"
    ...
    {"setG1Criterion",
        ...
        METH_VARARGS,
        "setG1Criterion($self, value, /)\n"
        "--\n"
        "\n"
        "setG1Criterion(value: float, /) -> None\n"
        "\n"
    ...
    {"setG2Criterion",
        ...
        METH_VARARGS,
        "setG2Criterion($self, value, /)\n"
        "--\n"
        "\n"
        "setG2Criterion(value: float, /) -> None\n"
        "\n"
    ...
    {"setPnt2dOnSurf",
        ...
        METH_VARARGS,
        "setPnt2dOnSurf($self, x, y, /)\n"
        "--\n"
        "\n"
        "setPnt2dOnSurf(x: float, y: float, /) -> None\n"
        "\n"
...
GeomPlate_PointConstraint *PointConstraintPy::getTwinPtr() const
{
    return getGeomPlate_PointConstraintPtr();
}
