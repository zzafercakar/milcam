...
PyTypeObject BuildPlateSurfacePy::Type = {
    ...
    .tp_name = "Part.GeomPlate.BuildPlateSurfacePy",
    .tp_basicsize = sizeof(BuildPlateSurfacePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "This class provides an algorithm for constructing such a plate surface.",
    .tp_methods = Part::BuildPlateSurfacePy::Methods,
    .tp_getset = Part::BuildPlateSurfacePy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BuildPlateSurfacePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef BuildPlateSurfacePy::Methods[] = {
    ...
    {"loadInitSurface",
        ...
        METH_VARARGS,
        "loadInitSurface($self)\n"
        "--\n"
        "\n"
        "loadInitSurface() -> None\n"
        "\n"
    ...
    {"curveConstraint",
        ...
        METH_VARARGS,
        "curveConstraint($self)\n"
        "--\n"
        "\n"
        "curveConstraint() -> object\n"
        "\n"
...
GeomPlate_BuildPlateSurface *BuildPlateSurfacePy::getTwinPtr() const
{
    return getGeomPlate_BuildPlateSurfacePtr();
}
