...
PyMethodDef BSplineCurvePy::Methods[] = {
    ...
    {"increaseDegree",
        ...
        METH_VARARGS,
        "increaseDegree($self, Degree=..., /)\n"
        "--\n"
        "\n"
        "increaseDegree(Degree: int=..., /) -> None\n"
        "\n"
        "increase(Int=Degree)\n"
    ...
    {"increaseMultiplicity",
        ...
        METH_VARARGS,
        "increaseMultiplicity($self, *args, **kwargs)\n"
        "--\n"
        "\n"
        "increaseMultiplicity(index: int, mult: int, /) -> None\n"
        "increaseMultiplicity(start: int, end: int, mult: int, /) -> None\n"
        "\n"
    ...
    {"incrementMultiplicity",
        ...
        METH_VARARGS,
        "incrementMultiplicity($self, start, end, mult, /)\n"
        "--\n"
        "\n"
        "incrementMultiplicity(start: int, end: int, mult: int, /) -> None\n"
        "\n"
    ...
    {"insertKnot",
        ...
        METH_VARARGS,
        "insertKnot($self, u, mult=1, tol=0.0, /)\n"
        "--\n"
        "\n"
        "insertKnot(u: float, mult: int=1, tol: float=0.0, /) -> None\n"
        "\n"
    ...
    {"insertKnots",
        ...
        METH_VARARGS,
        "insertKnots($self, list_of_floats, list_of_ints, tol=0.0, bool_add=True, /)\n"
        "--\n"
        "\n"
        "insertKnots(list_of_floats: List[float], list_of_ints: List[int], tol: float=0.0, bool_add: bool=True, /) -> None\n"
        "\n"
    ...
    {"removeKnot",
        ...
        METH_VARARGS,
        "removeKnot($self, Index, M, tol, /)\n"
        "--\n"
        "\n"
        "removeKnot(Index: int, M: int, tol: float, /) -> bool\n"
        "\n"
    ...
    {"segment",
        ...
        "--\n"
        "\n"
        "segment(u1: float, u2: float, /) -> None\n"
        "\n"
        "segment(u1,u2)\n"
        "\n"
    ...
    {"split",
        ...
        METH_VARARGS,
        "split($self, u, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "split(u: float, tolerance: float=0.0, /) -> tuple[BSplineCurve, BSplineCurve]\n"
        "\n"
    ...
    {"setKnot",
        ...
        METH_VARARGS,
        "setKnot($self, knot, index, /)\n"
        "--\n"
        "\n"
        "setKnot(knot: float, index: int, /) -> None\n"
        "\n"
    ...
    {"setKnots",
        ...
        "--\n"
        "\n"
        "setKnots(knots: List[float], /) -> None\n"
        "\n"
    ...
    {"setPole",
        ...
        METH_VARARGS,
        "setPole($self, P, Index, /)\n"
        "--\n"
        "\n"
        "setPole(P: Vector, Index: int, /) -> None\n"
        "\n"
    ...
    {"setWeight",
        ...
        METH_VARARGS,
        "setWeight($self, weight, index, /)\n"
        "--\n"
        "\n"
        "setWeight(weight: float, index: int, /) -> None\n"
        "\n"
    ...
    {"getResolution",
        ...
        "--\n"
        "\n"
        "getResolution(Tolerance3D: float, /) -> float\n"
        "\n"
    ...
    {"movePoint",
        ...
        METH_VARARGS,
        "movePoint($self, U, P, Index1, Index2, /)\n"
        "--\n"
        "\n"
        "movePoint(U: float, P: Vector, Index1: int, Index2: int, /) -> tuple[int, int]\n"
        "\n"
    ...
    {"setOrigin",
        ...
        METH_VARARGS,
        "setOrigin($self, Index, /)\n"
        "--\n"
        "\n"
        "setOrigin(Index: int, /) -> None\n"
        "\n"
    ...
    {"getMultiplicity",
        ...
        METH_VARARGS,
        "getMultiplicity($self, index, /)\n"
        "--\n"
        "\n"
        "getMultiplicity(index: int, /) -> int\n"
        "\n"
    ...
    {"getMultiplicities",
        ...
        METH_VARARGS,
        "getMultiplicities($self)\n"
        "--\n"
        "\n"
        "getMultiplicities() -> List[int]\n"
        "\n"
    ...
    {"approximate",
        ...
        "approximate($self, **kwargs)\n"
        "--\n"
        "\n"
        "approximate(Points: List[Vector], DegMin: int=3, DegMax: int=8, Tolerance: float=0.001, Continuity: str='C2', LengthWeight: float=0.0, CurvatureWeight: float=0.0, TorsionWeight: float=0.0, Parameters: List[float]=None, ParamType: str='Uniform') -> None\n"
        "\n"
    ...
    {"getCardinalSplineTangents",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "getCardinalSplineTangents($self, **kwargs)\n"
        "--\n"
        "\n"
        "getCardinalSplineTangents(**kwargs) -> List[Vector]\n"
        "\n"
    ...
    {"interpolate",
        ...
        "--\n"
        "\n"
        "interpolate(Points: List[Vector], PeriodicFlag: bool=False, Tolerance: float=1e-06, Parameters: List[float]=None, InitialTangent: Vector=None, FinalTangent: Vector=None, Tangents: List[Vector]=None, TangentFlags: List[bool]=None) -> None\n"
        "\n"
    ...
    {"buildFromPoles",
        ...
        METH_VARARGS,
        "buildFromPoles($self, poles, periodic=False, degree=3, interpolate=False, /)\n"
        "--\n"
        "\n"
        "buildFromPoles(poles: List[Vector], periodic: bool=False, degree: int=3, interpolate: bool=False, /) -> None\n"
        "\n"
    ...
    {"buildFromPolesMultsKnots",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "buildFromPolesMultsKnots($self, **kwargs)\n"
        "--\n"
        "\n"
        "buildFromPolesMultsKnots(poles: List[Vector], mults: List[int], knots: List[float], periodic: bool, degree: int, weights: List[float]=None, CheckRational: bool=False) -> None\n"
        "\n"
    ...
    {"toBiArcs",
        ...
        METH_VARARGS,
        "toBiArcs($self, tolerance, /)\n"
        "--\n"
        "\n"
        "toBiArcs(tolerance: float, /) -> List[Arc]\n"
        "\n"
    ...
    {"makeC1Continuous",
        ...
        METH_VARARGS,
        "makeC1Continuous($self, tol=1e-06, ang_tol=1e-07, /)\n"
        "--\n"
        "\n"
        "makeC1Continuous(tol: float=1e-06, ang_tol: float=1e-07, /) -> 'BSplineCurve'\n"
        "\n"
    ...
    {"scaleKnotsToBounds",
        ...
        METH_VARARGS,
        "scaleKnotsToBounds($self, u0=0.0, u1=1.0, /)\n"
        "--\n"
        "\n"
        "scaleKnotsToBounds(u0: float=0.0, u1: float=1.0, /) -> None\n"
        "\n"
...
// PyObject*  BSplineCurvePy::split(PyObject *args){};
// has to be implemented in BSplineCurvePyImp.cpp
PyObject * BSplineCurvePy::staticCallback_split (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'split' of 'Part.GeomBSplineCurve' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<BSplineCurvePy*>(self)->split(args);
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
    catch(const Base::Exception& e)
    {
...
GeomBSplineCurve *BSplineCurvePy::getTwinPtr() const
{
    return getGeomBSplineCurvePtr();
}
