...
PyMethodDef TopoShapeWirePy::Methods[] = {
    ...
    {"fixWire",
        ...
        METH_VARARGS,
        "fixWire($self, face=None, tolerance=None, /)\n"
        "--\n"
        "\n"
        "fixWire(face: Optional[object]=None, tolerance: Optional[float]=None, /) -> None\n"
        "\n"
    ...
    {"makeHomogenousWires",
        ...
        METH_VARARGS,
        "makeHomogenousWires($self, wire, /)\n"
        "--\n"
        "\n"
        "makeHomogenousWires(wire: object, /) -> object\n"
        "\n"
    ...
    {"makePipe",
        ...
        METH_VARARGS,
        "makePipe($self, profile, /)\n"
        "--\n"
        "\n"
        "makePipe(profile: object, /) -> object\n"
        "\n"
    ...
    {"makePipeShell",
        ...
        METH_VARARGS,
        "makePipeShell($self, shapeList, isSolid=False, isFrenet=False, transition=0, /)\n"
        "--\n"
        "\n"
        "makePipeShell(shapeList: List[object], isSolid: bool=False, isFrenet: bool=False, transition: int=0, /) -> object\n"
        "\n"
    ...
    {"approximate",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "approximate($self, Tol2d=None, Tol3d=0.0001, MaxSegments=10, MaxDegree=3)\n"
        "--\n"
        "\n"
        "approximate(Tol2d: float=None, Tol3d: float=0.0001, MaxSegments: int=10, MaxDegree: int=3) -> object\n"
        "\n"
    ...
    {"discretize",
        ...
        "--\n"
        "\n"
        "discretize(Number: int) -> List[object]\n"
        "discretize(QuasiNumber: int) -> List[object]\n"
        "discretize(Distance: float) -> List[object]\n"
        "discretize(Deflection: float) -> List[object]\n"
        "discretize(QuasiDeflection: float) -> List[object]\n"
        "discretize(Angular: float, Curvature: float, Minimum: int=2) -> List[object]\n"
        "\n"
...
TopoShape *TopoShapeWirePy::getTwinPtr() const
{
