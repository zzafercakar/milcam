...
PyTypeObject SurfaceOfExtrusionPy::Type = {
    ...
    .tp_name = "Part.SurfaceOfExtrusion",
    .tp_basicsize = sizeof(SurfaceOfExtrusionPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a surface of linear extrusion",
    .tp_methods = Part::SurfaceOfExtrusionPy::Methods,
    .tp_getset = Part::SurfaceOfExtrusionPy::GetterSetter,
    .tp_base = &Part::GeometrySurfacePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::SurfaceOfExtrusionPy::PyMake
};
#if defined(__GNUC__)
...
GeomSurfaceOfExtrusion *SurfaceOfExtrusionPy::getTwinPtr() const
{
    return getGeomSurfaceOfExtrusionPtr();
}
...
PyObject *SurfaceOfExtrusionPy::PyMake(PyTypeObject* /*type*/, PyObject* /*args*/, PyObject* /*kwds*/)
{
...
{
    return {"<GeomSurfaceOfExtrusion object>"};
}
