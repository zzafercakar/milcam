...
PyMethodDef PartFeaturePy::Methods[] = {
    {"getElementHistory",
        ...
        "getElementHistory($self, name, *, recursive=True, sameType=False, showName=False)\n"
        "--\n"
        "\n"
        "getElementHistory(name: str, *, recursive: bool=True, sameType: bool=False, showName: bool=False) -> Union[Tuple[DocumentObject, str, List[str]], List[Tuple[DocumentObject, str, List[str]]]]\n"
        "\n"
...
Feature *PartFeaturePy::getTwinPtr() const
{
