...
PyMethodDef TopoShapeCompoundPy::Methods[] = {
    ...
    {"connectEdgesToWires",
        ...
        METH_VARARGS,
        "connectEdgesToWires($self, Shared=True, Tolerance=1e-07, /)\n"
        "--\n"
        "\n"
        "connectEdgesToWires(Shared: bool=True, Tolerance: float=1e-07, /) -> 'TopoShapeCompound'\n"
        "\n"
...
TopoShape *TopoShapeCompoundPy::getTwinPtr() const
{
