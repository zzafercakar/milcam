...
PyTypeObject ChFi2d_FilletAlgoPy::Type = {
    ...
    .tp_name = "Part.ChFi2d.FilletAlgo",
    .tp_basicsize = sizeof(ChFi2d_FilletAlgoPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_methods = Part::ChFi2d_FilletAlgoPy::Methods,
    .tp_getset = Part::ChFi2d_FilletAlgoPy::GetterSetter,
    .tp_base = &Base::PyObjectBase::Type,
    .tp_init = __PyInit,
    .tp_new = Part::ChFi2d_FilletAlgoPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef ChFi2d_FilletAlgoPy::Methods[] = {
    ...
    {"result",
        ...
        METH_VARARGS,
        "result($self, point, solution=-1, /)\n"
        "--\n"
        "\n"
        "result(point: Vector, solution: int=-1, /) -> tuple[object, object, object]\n"
        "\n"
...
ChFi2d_FilletAlgo *ChFi2d_FilletAlgoPy::getTwinPtr() const
{
    return getChFi2d_FilletAlgoPtr();
}
