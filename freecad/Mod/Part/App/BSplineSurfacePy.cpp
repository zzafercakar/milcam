...
PyTypeObject BSplineSurfacePy::Type = {
    ...
    .tp_name = "Part.BSplineSurface",
    .tp_basicsize = sizeof(BSplineSurfacePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Describes a B-Spline surface in 3D space",
    .tp_methods = Part::BSplineSurfacePy::Methods,
    .tp_getset = Part::BSplineSurfacePy::GetterSetter,
    .tp_base = &Part::GeometrySurfacePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::BSplineSurfacePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef BSplineSurfacePy::Methods[] = {
    ...
    {"increaseDegree",
        ...
        METH_VARARGS,
        "increaseDegree($self, DegMin, DegMax, Continuity, Tolerance, X0=..., dX=..., Y0=..., dY=..., /)\n"
        "--\n"
        "\n"
        "increaseDegree(DegMin: int, DegMax: int, Continuity: int, Tolerance: float, X0: float=..., dX: float=..., Y0: float=..., dY: float=..., /) -> None\n"
        "\n"
    ...
    {"increaseUMultiplicity",
        ...
        METH_VARARGS,
        "increaseUMultiplicity($self)\n"
        "--\n"
        "\n"
        "increaseUMultiplicity() -> None\n"
        "\n"
    ...
    {"increaseVMultiplicity",
        ...
        METH_VARARGS,
        "increaseVMultiplicity($self)\n"
        "--\n"
        "\n"
        "increaseVMultiplicity() -> None\n"
        "\n"
    ...
    {"incrementUMultiplicity",
        ...
        METH_VARARGS,
        "incrementUMultiplicity($self)\n"
        "--\n"
        "\n"
        "incrementUMultiplicity() -> None\n"
        "\n"
    ...
    {"incrementVMultiplicity",
        ...
        METH_VARARGS,
        "incrementVMultiplicity($self)\n"
        "--\n"
        "\n"
        "incrementVMultiplicity() -> None\n"
        "\n"
    ...
    {"insertUKnot",
        ...
        METH_VARARGS,
        "insertUKnot($self, U, Index, Tolerance, /)\n"
        "--\n"
        "\n"
        "insertUKnot(U: float, Index: int, Tolerance: float, /) -> None\n"
        "\n"
    ...
    {"insertUKnots",
        ...
        METH_VARARGS,
        "insertUKnots($self, U, Mult, Tolerance, /)\n"
        "--\n"
        "\n"
        "insertUKnots(U: List[float], Mult: List[float], Tolerance: float, /) -> None\n"
        "\n"
    ...
    {"insertVKnot",
        ...
        METH_VARARGS,
        "insertVKnot($self, V, Index, Tolerance, /)\n"
        "--\n"
        "\n"
        "insertVKnot(V: float, Index: int, Tolerance: float, /) -> None\n"
        "\n"
    ...
    {"insertVKnots",
        ...
        METH_VARARGS,
        "insertVKnots($self, V, Mult, Tolerance, /)\n"
        "--\n"
        "\n"
        "insertVKnots(V: List[float], Mult: List[float], Tolerance: float, /) -> None\n"
        "\n"
    ...
    {"removeUKnot",
        ...
        METH_VARARGS,
        "removeUKnot($self, M, Index, Tolerance, /)\n"
        "--\n"
        "\n"
        "removeUKnot(M: int, Index: int, Tolerance: float, /) -> bool\n"
        "\n"
    ...
    {"removeVKnot",
        ...
        METH_VARARGS,
        "removeVKnot($self, M, Index, Tolerance, /)\n"
        "--\n"
        "\n"
        "removeVKnot(M: int, Index: int, Tolerance: float, /) -> bool\n"
        "\n"
        "Reduces to M the multiplicity of the knot of index Index in the given\n"
        "parametric direction. If M is 0, the knot is removed.\n"
        "With a modification of this type, the table of poles is also modified.\n"
    ...
    {"setUKnot",
        ...
        METH_VARARGS,
        "setUKnot($self, K, UIndex, M=..., /)\n"
        "--\n"
        "\n"
        "setUKnot(K: float, UIndex: int, M: int=..., /) -> None\n"
        "\n"
    ...
    {"setVKnot",
        ...
        METH_VARARGS,
        "setVKnot($self, K, VIndex, M=..., /)\n"
        "--\n"
        "\n"
        "setVKnot(K: float, VIndex: int, M: int=..., /) -> None\n"
        "\n"
        "Modifies this B-Spline surface by assigning the value K to the knot of index\n"
    ...
    {"getUKnot",
        ...
        METH_VARARGS,
        "getUKnot($self, UIndex, /)\n"
        "--\n"
        "\n"
        "getUKnot(UIndex: int, /) -> Any\n"
        "\n"
    ...
    {"getVKnot",
        ...
        METH_VARARGS,
        "getVKnot($self, VIndex, /)\n"
        "--\n"
        "\n"
        "getVKnot(VIndex: int, /) -> Any\n"
        "\n"
    ...
    {"setUKnots",
        ...
        METH_VARARGS,
        "setUKnots($self, knots, /)\n"
        "--\n"
        "\n"
        "setUKnots(knots: List[Any], /) -> None\n"
        "\n"
    ...
    {"setVKnots",
        ...
        METH_VARARGS,
        "setVKnots($self, knots, /)\n"
        "--\n"
        "\n"
        "setVKnots(knots: List[Any], /) -> None\n"
        "\n"
    ...
    {"setPole",
        ...
        METH_VARARGS,
        "setPole($self, P, UIndex, VIndex, Weight=..., /)\n"
        "--\n"
        "\n"
        "setPole(P: Any, UIndex: int, VIndex: int, Weight: float=..., /) -> None\n"
        "\n"
    ...
    {"setPoleCol",
        ...
        METH_VARARGS,
        "setPoleCol($self, VIndex, values, CPoleWeights, /)\n"
        "--\n"
        "\n"
        "setPoleCol(VIndex: int, values: List[Any], CPoleWeights: List[float], /) -> None\n"
        "\n"
    ...
    {"setPoleRow",
        ...
        METH_VARARGS,
        "setPoleRow($self, UIndex, values, CPoleWeights, /)\n"
        "--\n"
        "\n"
        "setPoleRow(UIndex: int, values: List[Any], CPoleWeights: List[float], /) -> None\n"
        "\n"
        "Modifies this B-Spline surface by assigning values to all or part\n"
    ...
    {"setWeight",
        ...
        METH_VARARGS,
        "setWeight($self, Weight, UIndex, VIndex, /)\n"
        "--\n"
        "\n"
        "setWeight(Weight: float, UIndex: int, VIndex: int, /) -> None\n"
        "\n"
    ...
    {"setWeightCol",
        ...
        METH_VARARGS,
        "setWeightCol($self, VIndex, CPoleWeights, /)\n"
        "--\n"
        "\n"
        "setWeightCol(VIndex: int, CPoleWeights: List[float], /) -> None\n"
        "\n"
    ...
    {"setWeightRow",
        ...
        METH_VARARGS,
        "setWeightRow($self, UIndex, CPoleWeights, /)\n"
        "--\n"
        "\n"
        "setWeightRow(UIndex: int, CPoleWeights: List[float], /) -> None\n"
        "\n"
        "Modifies this B-Spline surface by assigning values to all or part of the\n"
    ...
    {"getPolesAndWeights",
        ...
        METH_VARARGS,
        "getPolesAndWeights($self)\n"
        "--\n"
        "\n"
        "getPolesAndWeights() -> List[Any]\n"
        "\n"
    ...
    {"getResolution",
        ...
        "--\n"
        "\n"
        "getResolution(Tolerance3D: float, /) -> Any\n"
        "\n"
    ...
    {"movePoint",
        ...
        METH_VARARGS,
        "movePoint($self, U, V, P, UIndex1=..., UIndex2=..., VIndex1=..., VIndex2=..., /)\n"
        "--\n"
        "\n"
        "movePoint(U: float, V: float, P: Any, UIndex1: int=..., UIndex2: int=..., VIndex1: int=..., VIndex2: int=..., /) -> Any\n"
        "\n"
    ...
    {"setUNotPeriodic",
        ...
        METH_VARARGS,
        "setUNotPeriodic($self)\n"
        "--\n"
        "\n"
        "setUNotPeriodic() -> None\n"
        "\n"
    ...
    {"setVNotPeriodic",
        ...
        METH_VARARGS,
        "setVNotPeriodic($self)\n"
        "--\n"
        "\n"
        "setVNotPeriodic() -> None\n"
        "\n"
    ...
    {"setUPeriodic",
        ...
        METH_VARARGS,
        "setUPeriodic($self, I1, I2, /)\n"
        "--\n"
        "\n"
        "setUPeriodic(I1: int, I2: int, /) -> None\n"
        "\n"
    ...
    {"setVPeriodic",
        ...
        METH_VARARGS,
        "setVPeriodic($self, I1, I2, /)\n"
        "--\n"
        "\n"
        "setVPeriodic(I1: int, I2: int, /) -> None\n"
        "\n"
    ...
    {"setUOrigin",
        ...
        METH_VARARGS,
        "setUOrigin($self, Index, /)\n"
        "--\n"
        "\n"
        "setUOrigin(Index: int, /) -> None\n"
        "\n"
    ...
    {"setVOrigin",
        ...
        METH_VARARGS,
        "setVOrigin($self, Index, /)\n"
        "--\n"
        "\n"
        "setVOrigin(Index: int, /) -> None\n"
        "\n"
        "Assigns the knot of index Index in the knots table\n"
    ...
    {"getUMultiplicity",
        ...
        METH_VARARGS,
        "getUMultiplicity($self, UIndex, /)\n"
        "--\n"
        "\n"
        "getUMultiplicity(UIndex: int, /) -> Any\n"
        "\n"
    ...
    {"getVMultiplicity",
        ...
        METH_VARARGS,
        "getVMultiplicity($self, VIndex, /)\n"
        "--\n"
        "\n"
        "getVMultiplicity(VIndex: int, /) -> Any\n"
        "\n"
        "Returns, for this B-Spline surface, the multiplicity of\n"
    ...
    {"getUMultiplicities",
        ...
        METH_VARARGS,
        "getUMultiplicities($self)\n"
        "--\n"
        "\n"
        "getUMultiplicities() -> List[Any]\n"
        "\n"
    ...
    {"getVMultiplicities",
        ...
        METH_VARARGS,
        "getVMultiplicities($self)\n"
        "--\n"
        "\n"
        "getVMultiplicities() -> List[Any]\n"
        "\n"
        "Returns, for this B-Spline surface, the table of\n"
    ...
    {"approximate",
        ...
        "approximate($self, *, Points=..., DegMin=..., DegMax=..., Continuity=..., Tolerance=..., X0=..., dX=..., Y0=..., dY=..., ParamType=..., LengthWeight=..., CurvatureWeight=..., TorsionWeight=...)\n"
        "--\n"
        "\n"
        "approximate(*, Points: Any=..., DegMin: int=..., DegMax: int=..., Continuity: int=..., Tolerance: float=..., X0: float=..., dX: float=..., Y0: float=..., dY: float=..., ParamType: str=..., LengthWeight: float=..., CurvatureWeight: float=..., TorsionWeight: float=...) -> None\n"
        "\n"
    ...
    {"interpolate",
        ...
        METH_VARARGS,
        "interpolate($self, points=..., zpoints=..., X0=..., dX=..., Y0=..., dY=..., /)\n"
        "--\n"
        "\n"
        "interpolate(points: Any=..., zpoints: Any=..., X0: float=..., dX: float=..., Y0: float=..., dY: float=..., /) -> None\n"
        "\n"
        "interpolate(points)\n"
    ...
    {"buildFromPolesMultsKnots",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "buildFromPolesMultsKnots($self, *, poles, umults, vmults, uknots=..., vknots=..., uperiodic=..., vperiodic=..., udegree=..., vdegree=..., weights=...)\n"
        "--\n"
        "\n"
        "buildFromPolesMultsKnots(*, poles: List[List[Any]], umults: List[Any], vmults: List[Any], uknots: List[Any]=..., vknots: List[Any]=..., uperiodic: bool=..., vperiodic: bool=..., udegree: int=..., vdegree: int=..., weights: List[List[float]]=...) -> None\n"
        "\n"
    ...
    {"buildFromNSections",
        ...
        METH_VARARGS,
        "buildFromNSections($self, control_curves, /)\n"
        "--\n"
        "\n"
        "buildFromNSections(control_curves: Any, /) -> None\n"
        "\n"
    ...
    {"scaleKnotsToBounds",
        ...
        METH_VARARGS,
        "scaleKnotsToBounds($self, u0, u1, v0, v1, /)\n"
        "--\n"
        "\n"
        "scaleKnotsToBounds(u0: float, u1: float, v0: float, v1: float, /) -> None\n"
        "\n"
...
GeomBSplineSurface *BSplineSurfacePy::getTwinPtr() const
{
    return getGeomBSplineSurfacePtr();
}
