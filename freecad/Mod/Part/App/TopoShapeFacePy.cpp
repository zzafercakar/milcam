...
PyTypeObject TopoShapeFacePy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeFacePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "TopoShapeFace is the OpenCasCade topological face wrapper",
    .tp_methods = Part::TopoShapeFacePy::Methods,
    .tp_getset = Part::TopoShapeFacePy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeFacePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapeFacePy::Methods[] = {
    ...
    {"makeOffset",
        ...
        METH_VARARGS,
        "makeOffset($self, dist, /)\n"
        "--\n"
        "\n"
        "makeOffset(dist: float, /) -> object\n"
        "\n"
    ...
    {"makeEvolved",
        ...
        "--\n"
        "\n"
        "makeEvolved(Profile: TopoShape, Join: int, *, AxeProf: bool, Solid: bool, ProfOnSpine: bool, Tolerance: float) -> TopoShape\n"
        "\n"
    ...
    {"getUVNodes",
        ...
        "--\n"
        "\n"
        "getUVNodes() -> List[Tuple[float, float]]\n"
        "\n"
    ...
    {"tangentAt",
        ...
        "--\n"
        "\n"
        "tangentAt(u: float, v: float, /) -> Vector\n"
        "\n"
    ...
    {"valueAt",
        ...
        "--\n"
        "\n"
        "valueAt(u: float, v: float, /) -> Vector\n"
        "\n"
    ...
    {"derivative1At",
        ...
        METH_VARARGS,
        "derivative1At($self, u, v, /)\n"
        "--\n"
        "\n"
        "derivative1At(u: float, v: float, /) -> Tuple[Vector, Vector]\n"
        "\n"
    ...
    {"derivative2At",
        ...
        METH_VARARGS,
        "derivative2At($self, u, v, /)\n"
        "--\n"
        "\n"
        "derivative2At(u: float, v: float, /) -> Tuple[Vector, Vector]\n"
        "\n"
    ...
    {"curvatureAt",
        ...
        METH_VARARGS,
        "curvatureAt($self, u, v, /)\n"
        "--\n"
        "\n"
        "curvatureAt(u: float, v: float, /) -> float\n"
        "\n"
    ...
    {"isPartOfDomain",
        ...
        METH_VARARGS,
        "isPartOfDomain($self, u, v, /)\n"
        "--\n"
        "\n"
        "isPartOfDomain(u: float, v: float, /) -> bool\n"
        "\n"
    ...
    {"makeHalfSpace",
        ...
        METH_VARARGS,
        "makeHalfSpace($self, pos, /)\n"
        "--\n"
        "\n"
        "makeHalfSpace(pos: object, /) -> object\n"
        "\n"
    ...
    {"curveOnSurface",
        ...
        METH_VARARGS,
        "curveOnSurface($self, Edge, /)\n"
        "--\n"
        "\n"
        "curveOnSurface(Edge: object, /) -> Optional[Tuple[object, float, float]]\n"
        "\n"
    ...
    {"cutHoles",
        ...
        METH_VARARGS,
        "cutHoles($self, list_of_wires, /)\n"
        "--\n"
        "\n"
        "cutHoles(list_of_wires: List[object], /) -> None\n"
        "\n"
...
TopoShape *TopoShapeFacePy::getTwinPtr() const
{
