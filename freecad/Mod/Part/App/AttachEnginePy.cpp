...
PyTypeObject AttachEnginePy::Type = {
    ...
    .tp_name = "Attacher.AttachEngine",
    .tp_basicsize = sizeof(AttachEnginePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "AttachEngine abstract class - the functionality of AttachableObject, but outside of DocumentObject",
    .tp_methods = Attacher::AttachEnginePy::Methods,
    .tp_getset = Attacher::AttachEnginePy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Attacher::AttachEnginePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef AttachEnginePy::Methods[] = {
    ...
    {"getRefTypeOfShape",
        ...
        METH_VARARGS,
        "getRefTypeOfShape($self, shape, /)\n"
        "--\n"
        "\n"
        "getRefTypeOfShape(shape: str, /) -> str\n"
        "\n"
    ...
    {"isFittingRefType",
        ...
        METH_VARARGS,
        "isFittingRefType($self, type_shape, type_needed, /)\n"
        "--\n"
        "\n"
        "isFittingRefType(type_shape: str, type_needed: str, /) -> bool\n"
        "\n"
    ...
    {"downgradeRefType",
        ...
        METH_VARARGS,
        "downgradeRefType($self, type, /)\n"
        "--\n"
        "\n"
        "downgradeRefType(type: str, /) -> str\n"
        "\n"
    ...
    {"getRefTypeInfo",
        ...
        METH_VARARGS,
        "getRefTypeInfo($self, type, /)\n"
        "--\n"
        "\n"
        "getRefTypeInfo(type: str, /) -> dict\n"
        "\n"
    ...
    {"calculateAttachedPlacement",
        ...
        METH_VARARGS,
        "calculateAttachedPlacement($self, orig_placement, /)\n"
        "--\n"
        "\n"
        "calculateAttachedPlacement(orig_placement: Placement, /) -> Optional[Placement]\n"
        "\n"
    ...
    {"readParametersFromFeature",
        ...
        METH_VARARGS,
        "readParametersFromFeature($self, document_object, /)\n"
        "--\n"
        "\n"
        "readParametersFromFeature(document_object: DocumentObject, /) -> None\n"
        "\n"
    ...
    {"writeParametersToFeature",
        ...
        METH_VARARGS,
        "writeParametersToFeature($self, document_object, /)\n"
        "--\n"
        "\n"
        "writeParametersToFeature(document_object: DocumentObject, /) -> None\n"
        "\n"
...
AttachEngine *AttachEnginePy::getTwinPtr() const
{
    return getAttachEnginePtr();
}
