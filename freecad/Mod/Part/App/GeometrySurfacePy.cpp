...
PyTypeObject GeometrySurfacePy::Type = {
    ...
    .tp_name = "Part.GeometrySurface",
    .tp_basicsize = sizeof(GeometrySurfacePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "The abstract class GeometrySurface is the root class of all surface objects.",
    .tp_methods = Part::GeometrySurfacePy::Methods,
    .tp_getset = Part::GeometrySurfacePy::GetterSetter,
    .tp_base = &Part::GeometryPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::GeometrySurfacePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef GeometrySurfacePy::Methods[] = {
    ...
    {"toShell",
        ...
        "toShell($self, Bounds, Segment)\n"
        "--\n"
        "\n"
        "toShell(Bounds: object, Segment: object) -> Any\n"
        "\n"
    ...
    {"tangent",
        ...
        "--\n"
        "\n"
        "tangent(u: float, v: float, /) -> Tuple[Vector, Vector]\n"
        "\n"
    ...
    {"projectPoint",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "projectPoint($self, Point, Method=...)\n"
        "--\n"
        "\n"
        "projectPoint(Point: Vector, Method: Literal['NearestPoint']='NearestPoint') -> Vector\n"
        "projectPoint(Point: Vector, Method: Literal['LowerDistance']) -> float\n"
        "projectPoint(Point: Vector, Method: Literal['LowerDistanceParameters']) -> Tuple[float, float]\n"
        "projectPoint(Point: Vector, Method: Literal['Distance']) -> List[float]\n"
        "projectPoint(Point: Vector, Method: Literal['Parameters']) -> List[Tuple[float, float]]\n"
        "projectPoint(Point: Vector, Method: Literal['Point']) -> List[Vector]\n"
        "\n"
    ...
    {"isUmbillic",
        ...
        "--\n"
        "\n"
        "isUmbillic(u: float, v: float, /) -> bool\n"
        "\n"
        "isUmbillic(u,v) -> bool\n"
    ...
    {"curvature",
        ...
        METH_VARARGS,
        "curvature($self, u, v, type, /)\n"
        "--\n"
        "\n"
        "curvature(u: float, v: float, type: str, /) -> float\n"
        "\n"
    ...
    {"curvatureDirections",
        ...
        METH_VARARGS,
        "curvatureDirections($self, u, v, /)\n"
        "--\n"
        "\n"
        "curvatureDirections(u: float, v: float, /) -> Tuple[Vector, Vector]\n"
        "\n"
    ...
    {"isPlanar",
        ...
        METH_VARARGS,
        "isPlanar($self, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "isPlanar(tolerance: float=0.0, /) -> bool\n"
        "\n"
        "isPlanar([float]) -> Bool\n"
    ...
    {"uIso",
        ...
        "--\n"
        "\n"
        "uIso(u: Tuple, /) -> Union[GeometryCurve, Line]\n"
        "\n"
    ...
    {"vIso",
        ...
        "--\n"
        "\n"
        "vIso(v: Tuple, /) -> Union[GeometryCurve, Line]\n"
        "\n"
    ...
    {"toBSpline",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "toBSpline($self, tolerance=1e-07, continuity_u='C1', continuity_v='C1', max_degree_u=25, max_degree_v=25, max_segments=1000, precision_code=0)\n"
        "--\n"
        "\n"
        "toBSpline(tolerance: float=1e-07, continuity_u: Literal['C0', 'G0', 'G1', 'C1', 'G2', 'C3', 'CN']='C1', continuity_v: Literal['C0', 'G0', 'G1', 'C1', 'G2', 'C3', 'CN']='C1', max_degree_u: int=25, max_degree_v: int=25, max_segments: int=1000, precision_code: int=0) -> Any\n"
        "\n"
    ...
    {"intersectSS",
        ...
        METH_VARARGS,
        "intersectSS($self, SecondSurface, precision_code=0, /)\n"
        "--\n"
        "\n"
        "intersectSS(SecondSurface: Any, precision_code: int=0, /) -> Any\n"
        "\n"
...
GeomSurface *GeometrySurfacePy::getTwinPtr() const
{
    return getGeomSurfacePtr();
}
