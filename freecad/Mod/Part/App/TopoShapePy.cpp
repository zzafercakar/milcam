...
PyTypeObject TopoShapePy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "TopoShape is the OpenCasCade topological shape wrapper.\n"
    ...
    .tp_methods = Part::TopoShapePy::Methods,
    .tp_getset = Part::TopoShapePy::GetterSetter,
    .tp_base = &Data::ComplexGeoDataPy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapePy::Methods[] = {
    ...
    {"writeInventor",
        ...
        "writeInventor($self, *, Mode, Deviation, Angle, FaceColors)\n"
        "--\n"
        "\n"
        "writeInventor(*, Mode: int, Deviation: float, Angle: float, FaceColors: object) -> str\n"
        "\n"
    ...
    {"exportIges",
        ...
        METH_VARARGS,
        "exportIges($self, filename, /)\n"
        "--\n"
        "\n"
        "exportIges(filename: str, /) -> None\n"
        "\n"
    ...
    {"exportStep",
        ...
        METH_VARARGS,
        "exportStep($self, filename, /)\n"
        "--\n"
        "\n"
        "exportStep(filename: str, /) -> None\n"
        "\n"
    ...
    {"exportBrep",
        ...
        METH_VARARGS,
        "exportBrep($self, filename, /)\n"
        "--\n"
        "\n"
        "exportBrep(filename: str, /) -> None\n"
        "\n"
    ...
    {"exportBinary",
        ...
        METH_VARARGS,
        "exportBinary($self, filename, /)\n"
        "--\n"
        "\n"
        "exportBinary(filename: str, /) -> None\n"
        "\n"
    ...
    {"exportStl",
        ...
        METH_VARARGS,
        "exportStl($self, filename, /)\n"
        "--\n"
        "\n"
        "exportStl(filename: str, /) -> None\n"
        "\n"
    ...
    {"importBrep",
        ...
        METH_VARARGS,
        "importBrep($self, filename, /)\n"
        "--\n"
        "\n"
        "importBrep(filename: str, /) -> None\n"
        "\n"
    ...
    {"importBinary",
        ...
        METH_VARARGS,
        "importBinary($self, filename, /)\n"
        "--\n"
        "\n"
        "importBinary(filename: str, /) -> None\n"
        "\n"
    ...
    {"importBrepFromString",
        ...
        METH_VARARGS,
        "importBrepFromString($self, s, displayProgressBar=True, /)\n"
        "--\n"
        "\n"
        "importBrepFromString(s: str, displayProgressBar: bool=True, /) -> None\n"
        "\n"
    ...
    {"extrude",
        ...
        "--\n"
        "\n"
        "extrude(vector: Vector, /) -> TopoShape\n"
        "\n"
    ...
    {"revolve",
        ...
        METH_VARARGS,
        "revolve($self, base, direction, angle, /)\n"
        "--\n"
        "\n"
        "revolve(base: Vector, direction: Vector, angle: float, /) -> TopoShape\n"
        "\n"
    ...
    {"check",
        ...
        METH_VARARGS,
        "check($self, runBopCheck=False, /)\n"
        "--\n"
        "\n"
        "check(runBopCheck: bool=False, /) -> bool\n"
        "\n"
    ...
    {"fuse",
        ...
        METH_VARARGS,
        "fuse($self, tools, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "fuse(tools: Tuple[TopoShape, ...], tolerance: float=0.0, /) -> TopoShape\n"
        "\n"
    ...
    {"multiFuse",
        ...
        METH_VARARGS,
        "multiFuse($self, tools, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "multiFuse(tools: Tuple[TopoShape, ...], tolerance: float=0.0, /) -> TopoShape\n"
        "\n"
        "Supports (OCCT 6.9.0 and above):\n"
        "- Fuzzy Boolean operations (global tolerance for a Boolean operation)\n"
        "- Support of multiple arguments for a single Boolean operation\n"
    ...
    {"common",
        ...
        METH_VARARGS,
        "common($self, tools, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "common(tools: Tuple[TopoShape, ...], tolerance: float=0.0, /) -> TopoShape\n"
        "\n"
        "Supports:\n"
        "- Fuzzy Boolean operations (global tolerance for a Boolean operation)\n"
    ...
    {"section",
        ...
        METH_VARARGS,
        "section($self, tool, tolerance=0.0, approximation=False, /)\n"
        "--\n"
        "\n"
        "section(tool: Tuple[TopoShape, ...], tolerance: float=0.0, approximation: bool=False, /) -> TopoShape\n"
        "\n"
    ...
    {"slices",
        ...
        METH_VARARGS,
        "slices($self, direction, distancesList, /)\n"
        "--\n"
        "\n"
        "slices(direction: Vector, distancesList: List[float], /) -> List\n"
        "\n"
    ...
    {"slice",
        ...
        METH_VARARGS,
        "slice($self, direction, distance, /)\n"
        "--\n"
        "\n"
        "slice(direction: Vector, distance: float, /) -> List\n"
        "\n"
    ...
    {"cut",
        ...
        METH_VARARGS,
        "cut($self, tool, tolerance=0.0, /)\n"
        "--\n"
        "\n"
        "cut(tool: Tuple[TopoShape, ...], tolerance: float=0.0, /) -> TopoShape\n"
        "\n"
        "Supports:\n"
        "- Fuzzy Boolean operations (global tolerance for a Boolean operation)\n"
        "- Support of multiple arguments for a single Boolean operation\n"
    ...
    {"generalFuse",
        ...
        METH_VARARGS,
        "generalFuse($self, shapes, fuzzy_value=0.0, /)\n"
        "--\n"
        "\n"
        "generalFuse(shapes: Tuple[TopoShape, ...], fuzzy_value: float=0.0, /) -> Tuple[TopoShape, List[List[TopoShape]]]\n"
        "\n"
    ...
    {"childShapes",
        ...
        METH_VARARGS,
        "childShapes($self, cumOri=True, cumLoc=True, /)\n"
        "--\n"
        "\n"
        "childShapes(cumOri: bool=True, cumLoc: bool=True, /) -> List\n"
        "\n"
    ...
    {"ancestorsOfType",
        ...
        METH_VARARGS,
        "ancestorsOfType($self, shape, shape_type, /)\n"
        "--\n"
        "\n"
        "ancestorsOfType(shape: TopoShape, shape_type: str, /) -> List\n"
        "\n"
    ...
    {"removeInternalWires",
        ...
        METH_VARARGS,
        "removeInternalWires($self, minimalArea, /)\n"
        "--\n"
        "\n"
        "removeInternalWires(minimalArea: float, /) -> bool\n"
        "\n"
    ...
    {"mirror",
        ...
        METH_VARARGS,
        "mirror($self, base, norm, /)\n"
        "--\n"
        "\n"
        "mirror(base: Vector, norm: Vector, /) -> TopoShape\n"
        "\n"
    ...
    {"transformGeometry",
        ...
        METH_VARARGS,
        "transformGeometry($self, matrix, /)\n"
        "--\n"
        "\n"
        "transformGeometry(matrix: Matrix, /) -> TopoShape\n"
        "\n"
    ...
    {"transformShape",
        ...
        METH_VARARGS,
        "transformShape($self, matrix, copy=False, checkScale=False, /)\n"
        "--\n"
        "\n"
    ...
    {"transformed",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "transformed($self, matrix, *, copy=False, checkScale=False, op=None)\n"
        "--\n"
        "\n"
        "transformed(matrix: Matrix, *, copy: bool=False, checkScale: bool=False, op: str=None) -> TopoShape\n"
        "\n"
    ...
    {"translated",
        ...
        "--\n"
        "\n"
        "translated(vector: Vector, /) -> TopoShape\n"
        "\n"
    ...
    {"rotate",
        ...
        METH_VARARGS,
        "rotate($self, base, dir, degree, /)\n"
        "--\n"
        "\n"
        "rotate(base: Vector, dir: Vector, degree: float, /) -> None\n"
        "\n"
    ...
    {"rotated",
        ...
        METH_VARARGS,
        "rotated($self, base, dir, degree, /)\n"
        "--\n"
        "\n"
        "rotated(base: Vector, dir: Vector, degree: float, /) -> TopoShape\n"
        "\n"
    ...
    {"scale",
        ...
        METH_VARARGS,
        "scale($self, factor, base=None, /)\n"
        "--\n"
        "\n"
        "scale(factor: float, base: Vector=None, /) -> None\n"
        "\n"
    ...
    {"scaled",
        ...
        METH_VARARGS,
        "scaled($self, factor, base=None, /)\n"
        "--\n"
        "\n"
        "scaled(factor: float, base: Vector=None, /) -> TopoShape\n"
        "\n"
    ...
    {"makeFillet",
        ...
        METH_VARARGS,
        "makeFillet($self, *args)\n"
        "--\n"
        "\n"
        "makeFillet(radius: float, edgeList: List, /) -> TopoShape\n"
        "makeFillet(radius1: float, radius2: float, edgeList: List, /) -> TopoShape\n"
        "\n"
        "Make fillet.\n"
    ...
    {"makeChamfer",
        ...
        METH_VARARGS,
        "makeChamfer($self, *args)\n"
        "--\n"
        "\n"
        "makeChamfer(radius: float, edgeList: List, /) -> TopoShape\n"
        "makeChamfer(radius1: float, radius2: float, edgeList: List, /) -> TopoShape\n"
        "\n"
        "Make chamfer.\n"
    ...
    {"makeThickness",
        ...
        METH_VARARGS,
        "makeThickness($self, faces, offset, tolerance, /)\n"
        "--\n"
        "\n"
        "makeThickness(faces: List, offset: float, tolerance: float, /) -> TopoShape\n"
        "\n"
    ...
    {"makeOffsetShape",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "makeOffsetShape($self, offset, tolerance, *, inter=False, self_inter=False, offsetMode=0, join=0, fill=False)\n"
        "--\n"
        "\n"
        "makeOffsetShape(offset: float, tolerance: float, *, inter: bool=False, self_inter: bool=False, offsetMode: int=0, join: int=0, fill: bool=False) -> TopoShape\n"
        "\n"
    ...
    {"makeOffset2D",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "makeOffset2D($self, offset, *, join=0, fill=False, openResult=False, intersection=False)\n"
        "--\n"
        "\n"
        "makeOffset2D(offset: float, *, join: int=0, fill: bool=False, openResult: bool=False, intersection: bool=False) -> TopoShape\n"
        "\n"
        "The function supports keyword arguments.\n"
    ...
    {"makeEvolved",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "makeEvolved($self, Profile, Join, AxeProf, *, Solid, ProfOnSpine, Tolerance)\n"
        "--\n"
        "\n"
        "makeEvolved(Profile: TopoShape, Join: int, AxeProf: bool, *, Solid: bool, ProfOnSpine: bool, Tolerance: float) -> None\n"
        "\n"
    ...
    {"makeWires",
        ...
        METH_VARARGS,
        "makeWires($self, op=None, /)\n"
        "--\n"
        "\n"
        "makeWires(op: str=None, /) -> TopoShape\n"
        "\n"
    ...
    {"isPartner",
        ...
        METH_VARARGS,
        "isPartner($self, shape, /)\n"
        "--\n"
        "\n"
        "isPartner(shape: TopoShape, /) -> bool\n"
        "\n"
    ...
    {"isCoplanar",
        ...
        METH_VARARGS,
        "isCoplanar($self, shape, tol=None, /)\n"
        "--\n"
        "\n"
        "isCoplanar(shape: TopoShape, tol: float=None, /) -> bool\n"
        "\n"
    ...
    {"findPlane",
        ...
        METH_VARARGS,
        "findPlane($self, tol=None, /)\n"
        "--\n"
        "\n"
        "findPlane(tol: float=None, /) -> TopoShape\n"
        "\n"
    ...
    {"fix",
        ...
        METH_VARARGS,
        "fix($self, working_precision, minimum_precision, maximum_precision, /)\n"
        "--\n"
        "\n"
        "fix(working_precision: float, minimum_precision: float, maximum_precision: float, /) -> bool\n"
        "\n"
    ...
    {"tessellate",
        ...
        "--\n"
        "\n"
        "tessellate() -> Tuple[List[Vector], List]\n"
        "\n"
    ...
    {"project",
        ...
        METH_VARARGS,
        "project($self, shapeList, /)\n"
        "--\n"
        "\n"
        "project(shapeList: List[TopoShape], /) -> TopoShape\n"
        "\n"
    ...
    {"makeParallelProjection",
        ...
        METH_VARARGS,
        "makeParallelProjection($self, shape, dir, /)\n"
        "--\n"
        "\n"
        "makeParallelProjection(shape: TopoShape, dir: Vector, /) -> TopoShape\n"
        "\n"
    ...
    {"makePerspectiveProjection",
        ...
        METH_VARARGS,
        "makePerspectiveProjection($self, shape, pnt, /)\n"
        "--\n"
        "\n"
        "makePerspectiveProjection(shape: TopoShape, pnt: Vector, /) -> TopoShape\n"
        "\n"
    ...
    {"reflectLines",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "reflectLines($self, ViewDir, *, ViewPos=None, UpDir=None, EdgeType=None, Visible=True, OnShape=False)\n"
        "--\n"
        "\n"
        "reflectLines(ViewDir: Vector, *, ViewPos: Vector=None, UpDir: Vector=None, EdgeType: str=None, Visible: bool=True, OnShape: bool=False) -> TopoShape\n"
        "\n"
    ...
    {"makeShapeFromMesh",
        ...
        METH_VARARGS,
        "makeShapeFromMesh($self, mesh, tolerance, /)\n"
        "--\n"
        "\n"
        "makeShapeFromMesh(mesh: Tuple[List[Vector], List], tolerance: float, /) -> TopoShape\n"
        "\n"
    ...
    {"copy",
        ...
        METH_VARARGS,
        "copy($self, copyGeom=True, copyMesh=False, /)\n"
        "--\n"
        "\n"
        "copy(copyGeom: bool=True, copyMesh: bool=False, /) -> TopoShape\n"
        "\n"
    ...
    {"replaceShape",
        ...
        METH_VARARGS,
        "replaceShape($self, tupleList, /)\n"
        "--\n"
        "\n"
        "replaceShape(tupleList: List[Tuple[TopoShape, TopoShape]], /) -> TopoShape\n"
        "\n"
    ...
    {"removeShape",
        ...
        METH_VARARGS,
        "removeShape($self, shapeList, /)\n"
        "--\n"
        "\n"
        "removeShape(shapeList: List[TopoShape], /) -> TopoShape\n"
        "\n"
    ...
    {"defeaturing",
        ...
        METH_VARARGS,
        "defeaturing($self, shapeList, /)\n"
        "--\n"
        "\n"
        "defeaturing(shapeList: List[TopoShape], /) -> TopoShape\n"
        "\n"
    ...
    {"isInside",
        ...
        METH_VARARGS,
        "isInside($self, point, tolerance, checkFace, /)\n"
        "--\n"
        "\n"
        "isInside(point: Vector, tolerance: float, checkFace: bool, /) -> bool\n"
        "\n"
    ...
    {"proximity",
        ...
        METH_VARARGS,
        "proximity($self, shape, tolerance=None, /)\n"
        "--\n"
        "\n"
        "proximity(shape: TopoShape, tolerance: float=None, /) -> Tuple[List[int], List[int]]\n"
        "\n"
    ...
    {"distToShape",
        ...
        METH_VARARGS,
        "distToShape($self, shape, tol=1e-07, /)\n"
        "--\n"
        "\n"
        "distToShape(shape: TopoShape, tol: float=1e-07, /) -> Tuple[float, List[Tuple[Vector, Vector]], List[Tuple]]\n"
        "\n"
    ...
    {"getElement",
        ...
        METH_VARARGS,
        "getElement($self, elementName, silent=False, /)\n"
        "--\n"
        "\n"
        "getElement(elementName: str, silent: bool=False, /) -> TopoShape\n"
        "\n"
    ...
    {"countElement",
        ...
        METH_VARARGS,
        "countElement($self, type, /)\n"
        "--\n"
        "\n"
        "countElement(type: str, /) -> int\n"
        "\n"
    ...
    {"mapSubElement",
        ...
        METH_VARARGS,
        "mapSubElement($self, shape, op='', /)\n"
        "--\n"
        "\n"
        "mapSubElement(shape: Union[TopoShape, Tuple[TopoShape, ...]], op: str='', /) -> None\n"
        "\n"
    ...
    {"mapShapes",
        ...
        METH_VARARGS,
        "mapShapes($self, generated, modified, op='', /)\n"
        "--\n"
        "\n"
        "mapShapes(generated: List[Tuple[TopoShape, TopoShape]], modified: List[Tuple[TopoShape, TopoShape]], op: str='', /) -> None\n"
        "\n"
    ...
    {"getElementHistory",
        ...
        METH_VARARGS,
        "getElementHistory($self, name, /)\n"
        "--\n"
        "\n"
        "getElementHistory(name: str, /) -> Union[Tuple[str, str, List[str]], None]\n"
        "\n"
    ...
    {"getTolerance",
        ...
        METH_VARARGS,
        "getTolerance($self, mode, ShapeType='Shape', /)\n"
        "--\n"
        "\n"
        "getTolerance(mode: int, ShapeType: str='Shape', /) -> float\n"
        "\n"
    ...
    {"overTolerance",
        ...
        METH_VARARGS,
        "overTolerance($self, value, ShapeType='Shape', /)\n"
        "--\n"
        "\n"
        "overTolerance(value: float, ShapeType: str='Shape', /) -> List[TopoShape]\n"
        "\n"
    ...
    {"inTolerance",
        ...
        METH_VARARGS,
        "inTolerance($self, valmin, valmax, ShapeType='Shape', /)\n"
        "--\n"
        "\n"
        "inTolerance(valmin: float, valmax: float, ShapeType: str='Shape', /) -> List[TopoShape]\n"
        "\n"
        "ShapeType is interpreted as in the method getTolerance"
    },
    {"globalTolerance",
        ...
        "--\n"
        "\n"
        "globalTolerance(mode: int, /) -> float\n"
        "\n"
        "mode = 0 : average\n"
        "mode > 0 : maximal\n"
        "mode < 0 : minimal"
    ...
    {"fixTolerance",
        ...
        METH_VARARGS,
        "fixTolerance($self, value, ShapeType='Shape', /)\n"
        "--\n"
        "\n"
        "fixTolerance(value: float, ShapeType: str='Shape', /) -> None\n"
        "\n"
    ...
    {"limitTolerance",
        ...
        METH_VARARGS,
        "limitTolerance($self, tmin, tmax=0, ShapeType='Shape', /)\n"
        "--\n"
        "\n"
        "limitTolerance(tmin: float, tmax: float=0, ShapeType: str='Shape', /) -> bool\n"
        "\n"
    ...
    {"optimalBoundingBox",
        ...
        METH_VARARGS,
        "optimalBoundingBox($self, useTriangulation=True, useShapeTolerance=False, /)\n"
        "--\n"
        "\n"
        "optimalBoundingBox(useTriangulation: bool=True, useShapeTolerance: bool=False, /) -> BoundBox\n"
        "\n"
    ...
    {"findSubShape",
        ...
        METH_VARARGS,
        "findSubShape($self, shape, /)\n"
        "--\n"
        "\n"
        "findSubShape(shape: TopoShape, /) -> Tuple[Union[str, None], int]\n"
        "\n"
    ...
    {"findSubShapesWithSharedVertex",
        ...
        METH_VARARGS|METH_KEYWORDS,
        "findSubShapesWithSharedVertex($self, shape, *, needName=False, checkGeometry=True, tol=1e-07, atol=1e-12)\n"
        "--\n"
        "\n"
        "findSubShapesWithSharedVertex(shape: TopoShape, *, needName: bool=False, checkGeometry: bool=True, tol: float=1e-07, atol: float=1e-12) -> Union[List[Tuple[str, TopoShape]], List[TopoShape]]\n"
        "\n"
    ...
    {"getChildShapes",
        ...
        METH_VARARGS,
        "getChildShapes($self, shapetype, avoidtype='', /)\n"
        "--\n"
        "\n"
        "getChildShapes(shapetype: str, avoidtype: str='', /) -> List[TopoShape]\n"
        "\n"
...
TopoShape *TopoShapePy::getTwinPtr() const
{
    return getTopoShapePtr();
}
