...
PyTypeObject TopoShapeEdgePy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeEdgePy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "TopoShapeEdge is the OpenCasCade topological edge wrapper",
    .tp_methods = Part::TopoShapeEdgePy::Methods,
    .tp_getset = Part::TopoShapeEdgePy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeEdgePy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapeEdgePy::Methods[] = {
    {"getParameterByLength",
        ...
        METH_VARARGS,
        "getParameterByLength($self, pos, tolerance=1e-07, /)\n"
        "--\n"
        "\n"
        "getParameterByLength(pos: float, tolerance: float=1e-07, /) -> float\n"
        "\n"
        "Args:\n"
    ...
    {"tangentAt",
        ...
        METH_VARARGS,
        "tangentAt($self, paramval, /)\n"
        "--\n"
        "\n"
        "tangentAt(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
    ...
    {"valueAt",
        ...
        METH_VARARGS,
        "valueAt($self, paramval, /)\n"
        "--\n"
        "\n"
        "valueAt(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
        "    paramval (float or int): The parameter value along the Edge at which to\n"
    ...
    {"parameters",
        ...
        METH_VARARGS,
        "parameters($self, face=..., /)\n"
        "--\n"
        "\n"
        "parameters(face: object=..., /) -> List[float]\n"
        "\n"
    ...
    {"parameterAt",
        ...
        METH_VARARGS,
        "parameterAt($self, vertex, /)\n"
        "--\n"
        "\n"
        "parameterAt(vertex: object, /) -> float\n"
        "\n"
    ...
    {"normalAt",
        ...
        METH_VARARGS,
        "normalAt($self, paramval, /)\n"
        "--\n"
        "\n"
        "normalAt(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
        "    paramval (float or int): The parameter value along the Edge at which to\n"
    ...
    {"derivative1At",
        ...
        METH_VARARGS,
        "derivative1At($self, paramval, /)\n"
        "--\n"
        "\n"
        "derivative1At(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
        "    paramval (float or int): The parameter value along the Edge at which to\n"
    ...
    {"derivative2At",
        ...
        METH_VARARGS,
        "derivative2At($self, paramval, /)\n"
        "--\n"
        "\n"
        "derivative2At(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
        "    paramval (float or int): The parameter value along the Edge at which to\n"
    ...
    {"derivative3At",
        ...
        METH_VARARGS,
        "derivative3At($self, paramval, /)\n"
        "--\n"
        "\n"
        "derivative3At(paramval: float, /) -> Vector\n"
        "\n"
        "Args:\n"
        "    paramval (float or int): The parameter value along the Edge at which to\n"
    ...
    {"curvatureAt",
        ...
        METH_VARARGS,
        "curvatureAt($self, paramval, /)\n"
        "--\n"
        "\n"
        "curvatureAt(paramval: float, /) -> float\n"
        "\n"
    ...
    {"centerOfCurvatureAt",
        ...
        METH_VARARGS,
        "centerOfCurvatureAt($self, paramval, /)\n"
        "--\n"
        "\n"
        "centerOfCurvatureAt(paramval: float, /) -> Vector\n"
        "\n"
    ...
    {"firstVertex",
        ...
        METH_VARARGS,
        "firstVertex($self, Orientation=False, /)\n"
        "--\n"
        "\n"
        "firstVertex(Orientation: bool=False, /) -> Vertex\n"
        "\n"
    ...
    {"lastVertex",
        ...
        METH_VARARGS,
        "lastVertex($self, Orientation=False, /)\n"
        "--\n"
        "\n"
        "lastVertex(Orientation: bool=False, /) -> Vertex\n"
        "\n"
        "If there is none a Null shape is returned.\n"
        "Orientation = True : taking into account the edge orientation"
    },
    {"discretize",
        ...
        "--\n"
        "\n"
        "discretize(Number: int, First: float=..., Last: float=...) -> List[Vector]\n"
        "discretize(QuasiNumber: int, First: float=..., Last: float=...) -> List[Vector]\n"
        "discretize(Distance: float, First: float=..., Last: float=...) -> List[Vector]\n"
        "discretize(Deflection: float, First: float=..., Last: float=...) -> List[Vector]\n"
        "discretize(QuasiDeflection: float, First: float=..., Last: float=...) -> List[Vector]\n"
        "discretize(Angular: float, Curvature: float, Minimum: int=..., First: float=..., Last: float=...) -> List[Vector]\n"
        "\n"
    ...
    {"curveOnSurface",
        ...
        METH_VARARGS,
        "curveOnSurface($self, idx, /)\n"
        "--\n"
        "\n"
        "curveOnSurface(idx: int, /) -> Tuple[object, object, object, float, float]\n"
        "\n"
...
TopoShape *TopoShapeEdgePy::getTwinPtr() const
{
