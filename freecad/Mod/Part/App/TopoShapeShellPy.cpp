...
PyTypeObject TopoShapeShellPy::Type = {
    ...
    .tp_basicsize = sizeof(TopoShapeShellPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Create a shell out of a list of faces",
    .tp_methods = Part::TopoShapeShellPy::Methods,
    .tp_getset = Part::TopoShapeShellPy::GetterSetter,
    .tp_base = &Part::TopoShapePy::Type,
    .tp_init = __PyInit,
    .tp_new = Part::TopoShapeShellPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef TopoShapeShellPy::Methods[] = {
    ...
    {"makeHalfSpace",
        ...
        METH_VARARGS,
        "makeHalfSpace($self, point, /)\n"
        "--\n"
        "\n"
        "makeHalfSpace(point: object, /) -> object\n"
        "\n"
...
TopoShape *TopoShapeShellPy::getTwinPtr() const
{
