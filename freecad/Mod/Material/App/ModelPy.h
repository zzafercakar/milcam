...
public:
    ...
    //@{
    /// callback for the addInheritance() method
    static PyObject * staticCallback_addInheritance (PyObject *self, PyObject *args);
    /// implementer for the addInheritance() method
    PyObject*  addInheritance(PyObject *args);
    ...
    /// setter for the DOI attribute
    void setDOI(Py::String arg);
