...
public:
    ...
    /// callback for the keys() method
    static PyObject * staticCallback_keys (PyObject *self, PyObject *args);
    /// implementer for the keys() method
    PyObject*  keys();
    /// callback for the values() method
    static PyObject * staticCallback_values (PyObject *self, PyObject *args);
    /// implementer for the values() method
    PyObject*  values();
    //@}
    ...
    Py::Object getLibraryIcon() const;
    ...
    ///getter callback for the PropertyObjects attribute
    static PyObject * staticCallback_getPropertyObjects (PyObject *self, void *closure);
    /// getter for the PropertyObjects attribute
    Py::Dict getPropertyObjects() const;
    /// setter callback for the PropertyObjects attribute
    static int staticCallback_setPropertyObjects (PyObject *self, PyObject *value, void *closure);
    // no setter method,  PropertyObjects is read only!
    //@}
