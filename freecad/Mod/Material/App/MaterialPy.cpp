...
PyTypeObject MaterialPy::Type = {
    ...
    .tp_name = "Materials.Material",
    .tp_basicsize = sizeof(MaterialPy),
    .tp_itemsize = 0,
    /* methods */
    .tp_dealloc = PyDestructor,
    .tp_repr = __repr,
    .tp_as_sequence = Materials::MaterialPy::Sequence,
    .tp_as_mapping = Materials::MaterialPy::Mapping,
    .tp_getattro = __getattro,
    .tp_setattro = __setattro,
    /* --- Flags to define presence of optional/expanded features */
    .tp_flags = Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT,
    .tp_doc = "Material descriptions.",
    .tp_methods = Materials::MaterialPy::Methods,
    .tp_getset = Materials::MaterialPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Materials::MaterialPy::PyMake
};
#if defined(__GNUC__)
...
PyMethodDef MaterialPy::Methods[] = {
    {"addPhysicalModel",
        ...
        METH_VARARGS,
        "addPhysicalModel($self)\n"
        "--\n"
        "\n"
        "addPhysicalModel() -> None\n"
        "\n"
    ...
    {"removePhysicalModel",
        ...
        METH_VARARGS,
        "removePhysicalModel($self)\n"
        "--\n"
        "\n"
        "removePhysicalModel() -> None\n"
        "\n"
    ...
    {"addAppearanceModel",
        ...
        METH_VARARGS,
        "addAppearanceModel($self)\n"
        "--\n"
        "\n"
        "addAppearanceModel() -> None\n"
        "\n"
    ...
    {"removeAppearanceModel",
        ...
        METH_VARARGS,
        "removeAppearanceModel($self)\n"
        "--\n"
        "\n"
        "removeAppearanceModel() -> None\n"
        "\n"
    ...
    {"hasAppearanceModel",
        ...
        METH_VARARGS,
        "hasAppearanceModel($self)\n"
        "--\n"
        "\n"
        "hasAppearanceModel() -> bool\n"
        "\n"
    ...
    {"isPhysicalModelComplete",
        ...
        METH_VARARGS,
        "isPhysicalModelComplete($self)\n"
        "--\n"
        "\n"
        "isPhysicalModelComplete() -> bool\n"
        "\n"
    ...
    {"isAppearanceModelComplete",
        ...
        METH_VARARGS,
        "isAppearanceModelComplete($self)\n"
        "--\n"
        "\n"
        "isAppearanceModelComplete() -> bool\n"
        "\n"
    ...
    {"hasPhysicalProperty",
        ...
        METH_VARARGS,
        "hasPhysicalProperty($self)\n"
        "--\n"
        "\n"
        "hasPhysicalProperty() -> bool\n"
        "\n"
    ...
    {"hasAppearanceProperty",
        ...
        METH_VARARGS,
        "hasAppearanceProperty($self)\n"
        "--\n"
        "\n"
        "hasAppearanceProperty() -> bool\n"
        "\n"
    ...
    {"hasLegacyProperties",
        ...
        METH_VARARGS,
        "hasLegacyProperties($self)\n"
        "--\n"
        "\n"
        "hasLegacyProperties() -> bool\n"
        "\n"
    ...
    {"getPhysicalValue",
        ...
        METH_VARARGS,
        "getPhysicalValue($self)\n"
        "--\n"
        "\n"
        "getPhysicalValue() -> str\n"
        "\n"
    ...
    {"setPhysicalValue",
        ...
        METH_VARARGS,
        "setPhysicalValue($self)\n"
        "--\n"
        "\n"
        "setPhysicalValue() -> None\n"
        "\n"
    ...
    {"setAppearanceValue",
        ...
        METH_VARARGS,
        "setAppearanceValue($self)\n"
        "--\n"
        "\n"
        "setAppearanceValue() -> None\n"
        "\n"
        "Set the value associated with the property"
    },
    {"setValue",
    ...
    {"keys",
        reinterpret_cast<PyCFunction>( staticCallback_keys ),
        METH_NOARGS,
        "keys($self)\n"
        "--\n"
        "\n"
    ...
    {"values",
        reinterpret_cast<PyCFunction>( staticCallback_values ),
        METH_NOARGS,
        "values($self)\n"
        "--\n"
        "\n"
...
PySequenceMethods MaterialPy::Sequence[] = { {
    sequence_length,
    nullptr,
    nullptr,
    sequence_item,
...
PyMappingMethods MaterialPy::Mapping[] = { {
    sequence_length,
    mapping_subscript,
    nullptr,
} };
...
PyGetSetDef MaterialPy::GetterSetter[] = {
    ...
    {"PropertyObjects",
        (getter) staticCallback_getPropertyObjects,
        (setter) staticCallback_setPropertyObjects,
...
// has to be implemented in MaterialPyImp.cpp
PyObject * MaterialPy::staticCallback_setValue (PyObject *self, PyObject *args)
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'setValue' of 'Materials.Material' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<MaterialPy*>(self)->setValue(args);
        if (ret != nullptr)
            static_cast<MaterialPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// keys() callback and implementer
// PyObject*  MaterialPy::keys(PyObject *args){};
// has to be implemented in MaterialPyImp.cpp
PyObject * MaterialPy::staticCallback_keys (PyObject *self, PyObject * Py_UNUSED(args))
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'keys' of 'Materials.Material' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<MaterialPy*>(self)->keys();
        if (ret != nullptr)
            static_cast<MaterialPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
// values() callback and implementer
// PyObject*  MaterialPy::values(PyObject *args){};
// has to be implemented in MaterialPyImp.cpp
PyObject * MaterialPy::staticCallback_values (PyObject *self, PyObject * Py_UNUSED(args))
{
    // make sure that not a null pointer is passed
    if (!self) {
        PyErr_SetString(PyExc_TypeError, "descriptor 'values' of 'Materials.Material' object needs an argument");
        return nullptr;
    }
    ...
    try { // catches all exceptions coming up from c++ and generate a python exception
        PyObject* ret = static_cast<MaterialPy*>(self)->values();
        if (ret != nullptr)
            static_cast<MaterialPy*>(self)->startNotify();
        return ret;
    } // Please sync the following catch implementation with PY_CATCH
...
int MaterialPy::staticCallback_setDirectory (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MaterialPy*>(self)->setDirectory(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'Directory' of object 'Material'");
        return -1;
    }
}
...
int MaterialPy::staticCallback_setParent (PyObject *self, PyObject *value, void * /*closure*/)
{
    ...
    try {
        static_cast<MaterialPy*>(self)->setParent(Py::String(value,false));
        return 0;
    } catch (const Py::Exception&) {
        // The exception text is already set
        return -1;
    } catch (...) {
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while writing attribute 'Parent' of object 'Material'");
        return -1;
    }
}
...
// PropertyObjects() callback and implementer
// PyObject*  MaterialPy::PropertyObjects(PyObject *args){};
// has to be implemented in MaterialPyImp.cpp
PyObject * MaterialPy::staticCallback_getPropertyObjects (PyObject *self, void * /*closure*/)
{
    if (!static_cast<PyObjectBase*>(self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
        return nullptr;
    ...
    try {
        return Py::new_reference_to(static_cast<MaterialPy*>(self)->getPropertyObjects());
    } catch (const Py::Exception&) {
        // The exception text is already set
        return nullptr;
    } catch (...) {
        PyErr_SetString(Base::PyExc_FC_GeneralError, "Unknown exception while reading attribute 'PropertyObjects' of object 'Material'");
        return nullptr;
    }
}

int MaterialPy::staticCallback_setPropertyObjects (PyObject *self, PyObject * /*value*/, void * /*closure*/)
{
    if (!static_cast<PyObjectBase*>(self)->isValid()){
        PyErr_SetString(PyExc_ReferenceError, "This object is already deleted most likely through closing a document. This reference is no longer valid!");
        return -1;
    ...
    PyErr_SetString(PyExc_AttributeError, "Attribute 'PropertyObjects' of object 'Material' is read-only");
    return -1;
}
...
Material *MaterialPy::getTwinPtr() const
{
...
Py_ssize_t MaterialPy::sequence_length(PyObject *)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not implemented");
    return -1;
}

PyObject * MaterialPy::sequence_item(PyObject *, Py_ssize_t)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not yet implemented");
    return nullptr;
}

PyObject * MaterialPy::mapping_subscript(PyObject *, PyObject *)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not yet implemented");
    return nullptr;
}

int MaterialPy::sequence_contains(PyObject *, PyObject *)
{
    PyErr_SetString(PyExc_NotImplementedError, "Not yet implemented");
    return -1;
}
