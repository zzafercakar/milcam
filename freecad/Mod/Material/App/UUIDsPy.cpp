...
PyTypeObject UUIDsPy::Type = {
    ...
    .tp_name = "Material.UUIDs",
    .tp_basicsize = sizeof(UUIDsPy),
    .tp_itemsize = 0,
    /* methods */
    ...
    .tp_doc = "Material model UUID identifiers.",
    .tp_methods = Materials::UUIDsPy::Methods,
    .tp_getset = Materials::UUIDsPy::GetterSetter,
    .tp_base = &Base::BaseClassPy::Type,
    .tp_init = __PyInit,
    .tp_new = Materials::UUIDsPy::PyMake
};
#if defined(__GNUC__)
...
ModelUUIDs *UUIDsPy::getTwinPtr() const
{
    return getModelUUIDsPtr();
}
