...
public:
    ...
    //@{
    /// callback for the addColumn() method
    static PyObject * staticCallback_addColumn (PyObject *self, PyObject *args);
    /// implementer for the addColumn() method
    PyObject*  addColumn(PyObject *args);
    //@}
    ...
    ///getter callback for the DisplayName attribute
    static PyObject * staticCallback_getDisplayName (PyObject *self, void *closure);
    /// getter for the DisplayName attribute
    Py::String getDisplayName() const;
    /// setter callback for the DisplayName attribute
    static int staticCallback_setDisplayName (PyObject *self, PyObject *value, void *closure);
    /// setter for the DisplayName attribute
    void setDisplayName(Py::String arg);
    ...
    ///getter callback for the Inheritance attribute
    static PyObject * staticCallback_getInheritance (PyObject *self, void *closure);
    /// getter for the Inheritance attribute
    Py::String getInheritance() const;
    /// setter callback for the Inheritance attribute
    static int staticCallback_setInheritance (PyObject *self, PyObject *value, void *closure);
    // no setter method,  Inheritance is read only!
    ...
    ModelProperty *getTwinPtr() const;
